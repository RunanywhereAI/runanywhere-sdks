...
```powershell
irm https://raw.githubusercontent.com/RunanywhereAI/runanywhere-sdks/main/rcli/scripts/install.ps1 | iex
```
...
```bash
# macOS (full MLX host):
CONFIGURATION=release ./rcli/scripts/build-mlx-cli.sh
