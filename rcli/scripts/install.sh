...
case "${OS}-${ARCH}" in
    ...
    Darwin-x86_64) error "Intel macOS builds are not published yet (Apple Silicon only). Build from source: see rcli/README.md" ;;
    *)             error "unsupported platform ${OS}/${ARCH}. Build from source: see rcli/README.md" ;;
esac
