...
The RunAnywhere SDK follows a modular, provider-based architecture with a shared C++ core. The iOS packaging source of truth is [`sdk/runanywhere-swift/ARCHITECTURE.md`](../../runanywhere-swift/ARCHITECTURE.md).
