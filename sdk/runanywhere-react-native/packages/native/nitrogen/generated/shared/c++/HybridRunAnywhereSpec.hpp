...
namespace margelo::nitro::runanywhere {
  ...
  class HybridRunAnywhereSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::shared_ptr<Promise<bool>> assignModel(const std::string& modelId, const std::string& framework) = 0;
      virtual std::shared_ptr<Promise<std::string>> getModelAssignment(const std::string& modelId) = 0;
      virtual std::shared_ptr<Promise<void>> clearModelAssignments() = 0;
      ...
      virtual std::shared_ptr<Promise<bool>> registerLlamaCppBackend() = 0;
      virtual std::shared_ptr<Promise<bool>> unregisterLlamaCppBackend() = 0;
      virtual std::shared_ptr<Promise<bool>> registerONNXBackend() = 0;
      virtual std::shared_ptr<Promise<bool>> unregisterONNXBackend() = 0;
