...
public class LLMGenerationOptions(
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      echo_prompt, n_threads, tool_calling, disable_thinking, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<LLMGenerationOptions> = object :
      ...
      override fun encodedSize(`value`: LLMGenerationOptions): Int {
        ...
        if (value.disable_thinking != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(25,
      ...
      override fun encode(writer: ProtoWriter, `value`: LLMGenerationOptions) {
        ...
        if (value.disable_thinking != false) ProtoAdapter.BOOL.encodeWithTag(writer, 25,
            value.disable_thinking)
