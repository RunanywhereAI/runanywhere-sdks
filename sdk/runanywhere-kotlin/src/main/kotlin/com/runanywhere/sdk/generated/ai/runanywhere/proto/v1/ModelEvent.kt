...
public class ModelEvent(
  ...
  ): ModelEvent = ModelEvent(kind, model_id, task_id, progress, bytes_downloaded, total_bytes,
      download_state, local_path, error, model_count, custom_model_name, custom_model_url,
      model_name, model_size_bytes, duration_ms, framework, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<ModelEvent> = object : ProtoAdapter<ModelEvent>(
      ...
      override fun encodedSize(`value`: ModelEvent): Int {
        ...
        if (value.kind != ModelEventKind.MODEL_EVENT_KIND_UNSPECIFIED) size +=
            ModelEventKind.ADAPTER.encodedSizeWithTag(1, value.kind)
        if (value.model_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(2, value.model_id)
        if (value.task_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(3, value.task_id)
        if (!value.progress.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(4,
            value.progress)
        if (value.bytes_downloaded != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(5,
            value.bytes_downloaded)
        if (value.total_bytes != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(6,
            value.total_bytes)
        if (value.download_state != "") size += ProtoAdapter.STRING.encodedSizeWithTag(7,
            value.download_state)
        if (value.local_path != "") size += ProtoAdapter.STRING.encodedSizeWithTag(8,
            value.local_path)
        if (value.error != "") size += ProtoAdapter.STRING.encodedSizeWithTag(9, value.error)
        if (value.model_count != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(10,
            value.model_count)
        if (value.custom_model_name != "") size += ProtoAdapter.STRING.encodedSizeWithTag(11,
            value.custom_model_name)
        if (value.custom_model_url != "") size += ProtoAdapter.STRING.encodedSizeWithTag(12,
            value.custom_model_url)
        if (value.model_name != "") size += ProtoAdapter.STRING.encodedSizeWithTag(13,
            value.model_name)
        if (value.model_size_bytes != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(14,
            value.model_size_bytes)
        if (value.duration_ms != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(15,
            value.duration_ms)
        if (value.framework != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(16, value.framework)
        return size
      }

      override fun encode(writer: ProtoWriter, `value`: ModelEvent) {
        if (value.kind != ModelEventKind.MODEL_EVENT_KIND_UNSPECIFIED)
        ...
        if (value.task_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 3, value.task_id)
        if (!value.progress.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 4, value.progress)
        if (value.bytes_downloaded != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 5,
            value.bytes_downloaded)
        if (value.total_bytes != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 6, value.total_bytes)
        if (value.download_state != "") ProtoAdapter.STRING.encodeWithTag(writer, 7,
            value.download_state)
        if (value.local_path != "") ProtoAdapter.STRING.encodeWithTag(writer, 8, value.local_path)
        if (value.error != "") ProtoAdapter.STRING.encodeWithTag(writer, 9, value.error)
        if (value.model_count != 0) ProtoAdapter.INT32.encodeWithTag(writer, 10, value.model_count)
        if (value.custom_model_name != "") ProtoAdapter.STRING.encodeWithTag(writer, 11,
            value.custom_model_name)
        if (value.custom_model_url != "") ProtoAdapter.STRING.encodeWithTag(writer, 12,
            value.custom_model_url)
        if (value.model_name != "") ProtoAdapter.STRING.encodeWithTag(writer, 13, value.model_name)
        if (value.model_size_bytes != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 14,
            value.model_size_bytes)
        if (value.duration_ms != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 15, value.duration_ms)
        if (value.framework != 0) ProtoAdapter.INT32.encodeWithTag(writer, 16, value.framework)
