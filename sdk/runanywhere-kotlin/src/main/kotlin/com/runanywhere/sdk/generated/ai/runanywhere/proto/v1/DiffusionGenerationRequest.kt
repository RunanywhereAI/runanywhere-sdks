...
public class DiffusionGenerationRequest(
  ...
  ): DiffusionGenerationRequest = DiffusionGenerationRequest(request_id, options, model_id,
      metadata, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<DiffusionGenerationRequest> = object :
        ProtoAdapter<DiffusionGenerationRequest>(
      ...
      override fun redact(`value`: DiffusionGenerationRequest): DiffusionGenerationRequest =
          value.copy(
