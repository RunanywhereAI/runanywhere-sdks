...
public class ComponentLifecycleSnapshotResult(
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ComponentLifecycleSnapshotResult{", separator = ", ",
        postfix = "}")
  }
  ...
  ): ComponentLifecycleSnapshotResult = ComponentLifecycleSnapshotResult(success, snapshots,
      error_message, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ComponentLifecycleSnapshotResult> = object :
        ProtoAdapter<ComponentLifecycleSnapshotResult>(
      ...
      override fun encodedSize(`value`: ComponentLifecycleSnapshotResult): Int {
        ...
        size += ComponentLifecycleSnapshot.ADAPTER.asRepeated().encodedSizeWithTag(2,
            value.snapshots)
      ...
      override fun redact(`value`: ComponentLifecycleSnapshotResult):
          ComponentLifecycleSnapshotResult = value.copy(
