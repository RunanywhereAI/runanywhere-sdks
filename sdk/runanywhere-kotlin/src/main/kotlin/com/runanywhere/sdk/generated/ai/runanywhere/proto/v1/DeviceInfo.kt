...
public class DeviceInfo(
  ...
  public val platform_extras: Map<String, String> = immutableCopyOf("platform_extras",
      platform_extras)
  ...
  override fun toString(): String {
    ...
    if (device_fingerprint != null) result +=
        """device_fingerprint=${sanitize(device_fingerprint)}"""
  ...
  ): DeviceInfo = DeviceInfo(device_model, device_name, platform, os_version, form_factor,
      architecture, chip_name, total_memory, available_memory, has_neural_engine,
      neural_engine_cores, gpu_family, battery_level, battery_state, is_low_power_mode, core_count,
      performance_cores, efficiency_cores, device_fingerprint, platform_extras, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<DeviceInfo> = object : ProtoAdapter<DeviceInfo>(
      ...
      private val platform_extrasAdapter: ProtoAdapter<Map<String, String>> by lazy {
          ProtoAdapter.newMapAdapter(ProtoAdapter.STRING, ProtoAdapter.STRING) }

      override fun encodedSize(`value`: DeviceInfo): Int {
        var size = value.unknownFields.size
        if (value.device_model != "") size += ProtoAdapter.STRING.encodedSizeWithTag(1,
            value.device_model)
        if (value.device_name != "") size += ProtoAdapter.STRING.encodedSizeWithTag(2,
            value.device_name)
        if (value.platform != "") size += ProtoAdapter.STRING.encodedSizeWithTag(3, value.platform)
        if (value.os_version != "") size += ProtoAdapter.STRING.encodedSizeWithTag(4,
            value.os_version)
        if (value.form_factor != "") size += ProtoAdapter.STRING.encodedSizeWithTag(5,
            value.form_factor)
        if (value.architecture != "") size += ProtoAdapter.STRING.encodedSizeWithTag(6,
            value.architecture)
        if (value.chip_name != "") size += ProtoAdapter.STRING.encodedSizeWithTag(7,
            value.chip_name)
        if (value.total_memory != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(8,
            value.total_memory)
        if (value.available_memory != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(9,
            value.available_memory)
        if (value.has_neural_engine != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(10,
            value.has_neural_engine)
        if (value.neural_engine_cores != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(11,
            value.neural_engine_cores)
        if (value.gpu_family != "") size += ProtoAdapter.STRING.encodedSizeWithTag(12,
            value.gpu_family)
        ...
        if (value.is_low_power_mode != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(15,
            value.is_low_power_mode)
        if (value.core_count != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(16,
            value.core_count)
        if (value.performance_cores != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(17,
            value.performance_cores)
        if (value.efficiency_cores != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(18,
            value.efficiency_cores)
      ...
      override fun encode(writer: ProtoWriter, `value`: DeviceInfo) {
        if (value.device_model != "") ProtoAdapter.STRING.encodeWithTag(writer, 1,
            value.device_model)
        if (value.device_name != "") ProtoAdapter.STRING.encodeWithTag(writer, 2, value.device_name)
        if (value.platform != "") ProtoAdapter.STRING.encodeWithTag(writer, 3, value.platform)
        if (value.os_version != "") ProtoAdapter.STRING.encodeWithTag(writer, 4, value.os_version)
        if (value.form_factor != "") ProtoAdapter.STRING.encodeWithTag(writer, 5, value.form_factor)
        if (value.architecture != "") ProtoAdapter.STRING.encodeWithTag(writer, 6,
            value.architecture)
        if (value.chip_name != "") ProtoAdapter.STRING.encodeWithTag(writer, 7, value.chip_name)
        if (value.total_memory != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 8,
            value.total_memory)
        if (value.available_memory != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 9,
            value.available_memory)
        if (value.has_neural_engine != false) ProtoAdapter.BOOL.encodeWithTag(writer, 10,
            value.has_neural_engine)
        if (value.neural_engine_cores != 0) ProtoAdapter.INT32.encodeWithTag(writer, 11,
            value.neural_engine_cores)
        if (value.gpu_family != "") ProtoAdapter.STRING.encodeWithTag(writer, 12, value.gpu_family)
        ...
        if (value.is_low_power_mode != false) ProtoAdapter.BOOL.encodeWithTag(writer, 15,
            value.is_low_power_mode)
        if (value.core_count != 0) ProtoAdapter.INT32.encodeWithTag(writer, 16, value.core_count)
        if (value.performance_cores != 0) ProtoAdapter.INT32.encodeWithTag(writer, 17,
            value.performance_cores)
        if (value.efficiency_cores != 0) ProtoAdapter.INT32.encodeWithTag(writer, 18,
            value.efficiency_cores)
