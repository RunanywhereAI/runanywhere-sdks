...
public class STTAudioSource(
  ...
  ): STTAudioSource = STTAudioSource(audio_data, file_uri, adapter_handle, encoding, audio_format,
      sample_rate, channels, bits_per_sample, duration_ms, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<STTAudioSource> = object : ProtoAdapter<STTAudioSource>(
      ...
      override fun encodedSize(`value`: STTAudioSource): Int {
        ...
        if (value.encoding != STTAudioEncoding.STT_AUDIO_ENCODING_UNSPECIFIED) size +=
            STTAudioEncoding.ADAPTER.encodedSizeWithTag(4, value.encoding)
        ...
        if (value.sample_rate != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(6,
            value.sample_rate)
        if (value.channels != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(7, value.channels)
        if (value.bits_per_sample != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(8,
      ...
      override fun encode(writer: ProtoWriter, `value`: STTAudioSource) {
        if (value.encoding != STTAudioEncoding.STT_AUDIO_ENCODING_UNSPECIFIED)
        ...
        if (value.sample_rate != 0) ProtoAdapter.INT32.encodeWithTag(writer, 6, value.sample_rate)
        if (value.channels != 0) ProtoAdapter.INT32.encodeWithTag(writer, 7, value.channels)
        if (value.bits_per_sample != 0) ProtoAdapter.INT32.encodeWithTag(writer, 8,
            value.bits_per_sample)
