...
public class SDKEventFilter(
  ...
  ): SDKEventFilter = SDKEventFilter(categories, components, destinations, minimum_severity,
      session_id, operation_id, correlation_id, source, trace_id, unknownFields)
    ...
    public val ADAPTER: ProtoAdapter<SDKEventFilter> = object : ProtoAdapter<SDKEventFilter>(
      ...
      override fun encodedSize(`value`: SDKEventFilter): Int {
        ...
        if (value.operation_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(6,
            value.operation_id)
        if (value.correlation_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(7,
            value.correlation_id)
        if (value.source != "") size += ProtoAdapter.STRING.encodedSizeWithTag(8, value.source)
        if (value.trace_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(9, value.trace_id)
        return size
      }
      ...
      override fun encode(writer: ProtoWriter, `value`: SDKEventFilter) {
        ...
        if (value.operation_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 6,
            value.operation_id)
        if (value.correlation_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 7,
            value.correlation_id)
        if (value.source != "") ProtoAdapter.STRING.encodeWithTag(writer, 8, value.source)
        if (value.trace_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 9, value.trace_id)
