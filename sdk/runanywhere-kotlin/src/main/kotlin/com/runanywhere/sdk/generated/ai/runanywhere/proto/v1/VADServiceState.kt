...
public class VADServiceState(
  ...
  ): VADServiceState = VADServiceState(is_ready, is_speech_active, energy_threshold, sample_rate,
      frame_length_ms, current_model, error_message, error_code, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<VADServiceState> = object : ProtoAdapter<VADServiceState>(
      ...
      override fun encodedSize(`value`: VADServiceState): Int {
        ...
        if (value.is_speech_active != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(2,
            value.is_speech_active)
        if (!value.energy_threshold.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(3,
            value.energy_threshold)
        if (value.sample_rate != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(4,
            value.sample_rate)
        if (value.frame_length_ms != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(5,
      ...
      override fun encode(writer: ProtoWriter, `value`: VADServiceState) {
        ...
        if (value.is_speech_active != false) ProtoAdapter.BOOL.encodeWithTag(writer, 2,
            value.is_speech_active)
        if (!value.energy_threshold.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 3,
            value.energy_threshold)
        if (value.sample_rate != 0) ProtoAdapter.INT32.encodeWithTag(writer, 4, value.sample_rate)
        if (value.frame_length_ms != 0) ProtoAdapter.INT32.encodeWithTag(writer, 5,
            value.frame_length_ms)
