...
public class CurrentModelResult(
  ...
  ): CurrentModelResult = CurrentModelResult(model_id, model, loaded_at_unix_ms, found,
      error_message, category, framework, resolved_path, resolved_artifacts, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<CurrentModelResult> = object :
      ...
      override fun encodedSize(`value`: CurrentModelResult): Int {
        ...
        if (value.found != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(5, value.found)
        ...
        if (value.category != ModelCategory.MODEL_CATEGORY_UNSPECIFIED) size +=
            ModelCategory.ADAPTER.encodedSizeWithTag(7, value.category)
        if (value.framework != InferenceFramework.INFERENCE_FRAMEWORK_UNSPECIFIED) size +=
            InferenceFramework.ADAPTER.encodedSizeWithTag(8, value.framework)
        if (value.resolved_path != "") size += ProtoAdapter.STRING.encodedSizeWithTag(9,
            value.resolved_path)
      ...
      override fun encode(writer: ProtoWriter, `value`: CurrentModelResult) {
        ...
        if (value.loaded_at_unix_ms != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 4,
            value.loaded_at_unix_ms)
        if (value.found != false) ProtoAdapter.BOOL.encodeWithTag(writer, 5, value.found)
        ...
        if (value.resolved_path != "") ProtoAdapter.STRING.encodeWithTag(writer, 9,
            value.resolved_path)
