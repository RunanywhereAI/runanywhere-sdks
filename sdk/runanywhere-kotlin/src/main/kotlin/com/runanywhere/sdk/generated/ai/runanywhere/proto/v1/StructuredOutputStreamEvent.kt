...
public class StructuredOutputStreamEvent(
  ...
  public val kind: StructuredOutputStreamEventKind =
  ...
  ): StructuredOutputStreamEvent = StructuredOutputStreamEvent(seq, timestamp_us, request_id, kind,
      token, partial_json, validation, result, error_message, error_code, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<StructuredOutputStreamEvent> = object :
        ProtoAdapter<StructuredOutputStreamEvent>(
      ...
      override fun encodedSize(`value`: StructuredOutputStreamEvent): Int {
        ...
        if (value.request_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(3,
            value.request_id)
        if (value.kind !=
            StructuredOutputStreamEventKind.STRUCTURED_OUTPUT_STREAM_EVENT_KIND_UNSPECIFIED) size +=
            StructuredOutputStreamEventKind.ADAPTER.encodedSizeWithTag(4, value.kind)
      ...
      override fun decode(reader: ProtoReader): StructuredOutputStreamEvent {
        ...
        var kind: StructuredOutputStreamEventKind =
            StructuredOutputStreamEventKind.STRUCTURED_OUTPUT_STREAM_EVENT_KIND_UNSPECIFIED
        var token: String = ""
      ...
      override fun redact(`value`: StructuredOutputStreamEvent): StructuredOutputStreamEvent =
          value.copy(
