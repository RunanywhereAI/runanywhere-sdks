...
public class GenerationEvent(
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      input_tokens, tokens_per_second, time_to_first_token_ms, is_streaming, temperature,
      max_tokens, context_length, model_name, duration_ms, framework, unknownFields)
    ...
    public val ADAPTER: ProtoAdapter<GenerationEvent> = object : ProtoAdapter<GenerationEvent>(
      ...
      override fun encodedSize(`value`: GenerationEvent): Int {
        ...
        if (value.input_tokens != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(24,
            value.input_tokens)
        if (!value.tokens_per_second.equals(0.0)) size += ProtoAdapter.DOUBLE.encodedSizeWithTag(25,
            value.tokens_per_second)
        if (value.time_to_first_token_ms != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(26,
            value.time_to_first_token_ms)
        if (value.is_streaming != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(27,
            value.is_streaming)
        if (!value.temperature.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(28,
            value.temperature)
        if (value.max_tokens != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(29,
            value.max_tokens)
        if (value.context_length != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(30,
            value.context_length)
        if (value.model_name != "") size += ProtoAdapter.STRING.encodedSizeWithTag(31,
            value.model_name)
        if (!value.duration_ms.equals(0.0)) size += ProtoAdapter.DOUBLE.encodedSizeWithTag(32,
            value.duration_ms)
        if (value.framework != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(33, value.framework)
        return size
      }
      ...
      override fun encode(writer: ProtoWriter, `value`: GenerationEvent) {
        ...
        if (value.input_tokens != 0) ProtoAdapter.INT32.encodeWithTag(writer, 24,
            value.input_tokens)
        if (!value.tokens_per_second.equals(0.0)) ProtoAdapter.DOUBLE.encodeWithTag(writer, 25,
            value.tokens_per_second)
        if (value.time_to_first_token_ms != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 26,
            value.time_to_first_token_ms)
        if (value.is_streaming != false) ProtoAdapter.BOOL.encodeWithTag(writer, 27,
            value.is_streaming)
        if (!value.temperature.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 28,
            value.temperature)
        if (value.max_tokens != 0) ProtoAdapter.INT32.encodeWithTag(writer, 29, value.max_tokens)
        if (value.context_length != 0) ProtoAdapter.INT32.encodeWithTag(writer, 30,
            value.context_length)
        if (value.model_name != "") ProtoAdapter.STRING.encodeWithTag(writer, 31, value.model_name)
        if (!value.duration_ms.equals(0.0)) ProtoAdapter.DOUBLE.encodeWithTag(writer, 32,
            value.duration_ms)
        if (value.framework != 0) ProtoAdapter.INT32.encodeWithTag(writer, 33, value.framework)
