...
public class STTStreamEvent(
  ...
  ): STTStreamEvent = STTStreamEvent(seq, timestamp_us, request_id, kind, partial, final_output,
    ...
    public val ADAPTER: ProtoAdapter<STTStreamEvent> = object : ProtoAdapter<STTStreamEvent>(
      ...
      override fun encodedSize(`value`: STTStreamEvent): Int {
        ...
        if (value.request_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(3,
            value.request_id)
        if (value.kind != STTStreamEventKind.STT_STREAM_EVENT_KIND_UNSPECIFIED) size +=
            STTStreamEventKind.ADAPTER.encodedSizeWithTag(4, value.kind)
      ...
      override fun encode(writer: ProtoWriter, `value`: STTStreamEvent) {
        ...
        if (value.kind != STTStreamEventKind.STT_STREAM_EVENT_KIND_UNSPECIFIED)
