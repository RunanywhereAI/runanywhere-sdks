...
public class DownloadPlanResult(
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      storage_namespace, resume_token, required_free_bytes_after_download, failure_reason,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<DownloadPlanResult> = object :
        ProtoAdapter<DownloadPlanResult>(
      ...
      override fun encodedSize(`value`: DownloadPlanResult): Int {
        ...
        if (value.can_start != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(1,
            value.can_start)
        ...
        if (value.total_bytes != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(4,
            value.total_bytes)
        if (value.requires_extraction != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(5,
            value.requires_extraction)
        if (value.can_resume != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(6,
            value.can_resume)
        if (value.resume_from_bytes != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(7,
      ...
      override fun encode(writer: ProtoWriter, `value`: DownloadPlanResult) {
        if (value.can_start != false) ProtoAdapter.BOOL.encodeWithTag(writer, 1, value.can_start)
        ...
        if (value.requires_extraction != false) ProtoAdapter.BOOL.encodeWithTag(writer, 5,
            value.requires_extraction)
        if (value.can_resume != false) ProtoAdapter.BOOL.encodeWithTag(writer, 6, value.can_resume)
        if (value.resume_from_bytes != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 7,
            value.resume_from_bytes)
