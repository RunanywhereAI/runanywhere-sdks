...
public class VoiceAgentTurnRequest(
  ...
  ): VoiceAgentTurnRequest = VoiceAgentTurnRequest(request_id, session_id, audio_data,
      sample_rate_hz, channels, encoding, session_config, metadata, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<VoiceAgentTurnRequest> = object :
        ProtoAdapter<VoiceAgentTurnRequest>(
      ...
      override fun encodedSize(`value`: VoiceAgentTurnRequest): Int {
        ...
        if (value.session_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(2,
            value.session_id)
        if (value.audio_data != ByteString.EMPTY) size += ProtoAdapter.BYTES.encodedSizeWithTag(3,
            value.audio_data)
        if (value.sample_rate_hz != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(4,
      ...
      override fun encode(writer: ProtoWriter, `value`: VoiceAgentTurnRequest) {
        ...
        if (value.audio_data != ByteString.EMPTY) ProtoAdapter.BYTES.encodeWithTag(writer, 3,
            value.audio_data)
        if (value.sample_rate_hz != 0) ProtoAdapter.INT32.encodeWithTag(writer, 4,
            value.sample_rate_hz)
