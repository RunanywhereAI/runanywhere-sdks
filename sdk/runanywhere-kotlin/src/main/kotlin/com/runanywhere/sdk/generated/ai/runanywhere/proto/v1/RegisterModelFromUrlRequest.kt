...
public class RegisterModelFromUrlRequest(
  ...
  ): RegisterModelFromUrlRequest = RegisterModelFromUrlRequest(url, name, framework, category,
      source, memory_required_bytes, supports_thinking, supports_lora, artifact_type,
      context_length, description, download_size_bytes, id, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<RegisterModelFromUrlRequest> = object :
        ProtoAdapter<RegisterModelFromUrlRequest>(
      ...
      override fun redact(`value`: RegisterModelFromUrlRequest): RegisterModelFromUrlRequest =
          value.copy(
