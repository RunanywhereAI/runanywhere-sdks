...
public class HybridRoutingPolicy(
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<HybridRoutingPolicy> = object :
        ProtoAdapter<HybridRoutingPolicy>(
      ...
      override fun encodedSize(`value`: HybridRoutingPolicy): Int {
        ...
        if (value.cascade != null) size += HybridCascade.ADAPTER.encodedSizeWithTag(2,
            value.cascade)
        if (value.rank != HybridRank.HYBRID_RANK_UNSPECIFIED) size +=
            HybridRank.ADAPTER.encodedSizeWithTag(3, value.rank)
        return size
      }
      ...
      override fun encode(writer: ProtoWriter, `value`: HybridRoutingPolicy) {
        ...
        if (value.cascade != null) HybridCascade.ADAPTER.encodeWithTag(writer, 2, value.cascade)
        if (value.rank != HybridRank.HYBRID_RANK_UNSPECIFIED)
