...
public class LoRAState(
  ...
  public val loaded_adapters: List<LoRAAdapterInfo> = immutableCopyOf("loaded_adapters",
      loaded_adapters)
  ...
  ): LoRAState = LoRAState(loaded_adapters, has_active_adapters, base_model_id, error_message,
      error_code, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<LoRAState> = object : ProtoAdapter<LoRAState>(
      ...
      override fun encodedSize(`value`: LoRAState): Int {
        ...
        if (value.has_active_adapters != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(2,
            value.has_active_adapters)
      ...
      override fun encode(writer: ProtoWriter, `value`: LoRAState) {
        ...
        if (value.has_active_adapters != false) ProtoAdapter.BOOL.encodeWithTag(writer, 2,
            value.has_active_adapters)
