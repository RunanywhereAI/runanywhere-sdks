...
public class TranscriptionMetadata(
  ...
  ): TranscriptionMetadata = TranscriptionMetadata(model_id, processing_time_ms, audio_length_ms,
      real_time_factor, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<TranscriptionMetadata> = object :
        ProtoAdapter<TranscriptionMetadata>(
      ...
      override fun encodedSize(`value`: TranscriptionMetadata): Int {
        ...
        if (value.processing_time_ms != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(2,
            value.processing_time_ms)
        if (value.audio_length_ms != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(3,
            value.audio_length_ms)
        if (!value.real_time_factor.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(4,
      ...
      override fun encode(writer: ProtoWriter, `value`: TranscriptionMetadata) {
        ...
        if (value.processing_time_ms != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 2,
            value.processing_time_ms)
        if (value.audio_length_ms != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 3,
            value.audio_length_ms)
        if (!value.real_time_factor.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 4,
            value.real_time_factor)
