...
public class ComponentProgressEvent(
  ...
  ): ComponentProgressEvent = ComponentProgressEvent(component, operation, progress, message,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ComponentProgressEvent> = object :
        ProtoAdapter<ComponentProgressEvent>(
      ...
      override fun encodedSize(`value`: ComponentProgressEvent): Int {
        ...
        if (value.component != VoicePipelineComponent.VOICE_PIPELINE_COMPONENT_UNSPECIFIED) size +=
            VoicePipelineComponent.ADAPTER.encodedSizeWithTag(1, value.component)
        if (value.operation != "") size += ProtoAdapter.STRING.encodedSizeWithTag(2,
            value.operation)
        if (!value.progress.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(3,
            value.progress)
      ...
      override fun encode(writer: ProtoWriter, `value`: ComponentProgressEvent) {
        ...
        if (!value.progress.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 3, value.progress)
