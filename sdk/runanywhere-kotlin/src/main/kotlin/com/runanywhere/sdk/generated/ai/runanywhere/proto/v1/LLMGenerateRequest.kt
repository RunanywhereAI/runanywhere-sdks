...
public class LLMGenerateRequest(
  ...
  chat_history: List<String> = emptyList(),
  ...
  public val chat_history: List<String> = immutableCopyOf("chat_history", chat_history)
  ...
  override fun hashCode(): Int {
    ...
    if (result == 0) {
      ...
      result = result * 37 + chat_history.hashCode()
  ...
  override fun toString(): String {
    ...
    if (chat_history.isNotEmpty()) result += """chat_history=${sanitize(chat_history)}"""
  ...
  public fun copy(
    ...
    chat_history: List<String> = this.chat_history,
    unknownFields: ByteString = this.unknownFields,
      ...
      n_threads, metadata, options, chat_history, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<LLMGenerateRequest> = object :
      ...
      override fun encodedSize(`value`: LLMGenerateRequest): Int {
        ...
        size += ProtoAdapter.STRING.asRepeated().encodedSizeWithTag(27, value.chat_history)
        return size
      }
      ...
      override fun encode(writer: ProtoWriter, `value`: LLMGenerateRequest) {
        ...
        ProtoAdapter.STRING.asRepeated().encodeWithTag(writer, 27, value.chat_history)
      ...
      override fun decode(reader: ProtoReader): LLMGenerateRequest {
        ...
        val chat_history = mutableListOf<String>()
        val unknownFields = reader.forEachTag { tag ->
          when (tag) {
            ...
            27 -> chat_history.add(ProtoAdapter.STRING.decode(reader))
