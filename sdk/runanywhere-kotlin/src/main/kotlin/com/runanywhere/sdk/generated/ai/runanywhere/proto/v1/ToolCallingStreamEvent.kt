...
public class ToolCallingStreamEvent(
  ...
  public val kind: ToolCallingStreamEventKind =
  ...
  ): ToolCallingStreamEvent = ToolCallingStreamEvent(seq, timestamp_us, conversation_id, kind,
      token, tool_call, tool_result, result, error_message, error_code, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ToolCallingStreamEvent> = object :
        ProtoAdapter<ToolCallingStreamEvent>(
      ...
      override fun encodedSize(`value`: ToolCallingStreamEvent): Int {
        ...
        if (value.timestamp_us != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(2,
            value.timestamp_us)
        if (value.conversation_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(3,
            value.conversation_id)
        if (value.kind != ToolCallingStreamEventKind.TOOL_CALLING_STREAM_EVENT_KIND_UNSPECIFIED)
      ...
      override fun encode(writer: ProtoWriter, `value`: ToolCallingStreamEvent) {
        ...
        if (value.timestamp_us != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 2,
            value.timestamp_us)
        if (value.conversation_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 3,
            value.conversation_id)
        if (value.kind != ToolCallingStreamEventKind.TOOL_CALLING_STREAM_EVENT_KIND_UNSPECIFIED)
      ...
      override fun decode(reader: ProtoReader): ToolCallingStreamEvent {
        ...
        var kind: ToolCallingStreamEventKind =
            ToolCallingStreamEventKind.TOOL_CALLING_STREAM_EVENT_KIND_UNSPECIFIED
        var token: String = ""
