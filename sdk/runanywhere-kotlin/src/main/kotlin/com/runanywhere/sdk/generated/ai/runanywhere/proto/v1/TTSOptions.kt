...
public class TTSOptions(
  ...
  ): TTSOptions = TTSOptions(voice, language_code, speaking_rate, pitch, volume, enable_ssml, audio_format, sample_rate, speaker_id, speed, style, unknownFields)
    ...
    public val ADAPTER: ProtoAdapter<TTSOptions> = object : ProtoAdapter<TTSOptions>(
      ...
      override fun encodedSize(`value`: TTSOptions): Int {
        ...
        if (!value.speed.equals(0f)) {
          size += ProtoAdapter.FLOAT.encodedSizeWithTag(10, value.speed)
        }
      ...
      override fun encode(writer: ProtoWriter, `value`: TTSOptions) {
        ...
        if (!value.speed.equals(0f)) {
          ProtoAdapter.FLOAT.encodeWithTag(writer, 10, value.speed)
        }
