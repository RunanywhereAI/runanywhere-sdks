...
public class ChatGenerationResult(
  ...
  ): ChatGenerationResult = ChatGenerationResult(conversation_id, message, generation, tool_calls,
      tool_results, error_message, error_code, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ChatGenerationResult> = object :
        ProtoAdapter<ChatGenerationResult>(
      ...
      override fun encodedSize(`value`: ChatGenerationResult): Int {
        ...
        if (value.message != null) size += ChatMessage.ADAPTER.encodedSizeWithTag(2, value.message)
      ...
      override fun encode(writer: ProtoWriter, `value`: ChatGenerationResult) {
        if (value.conversation_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 1,
            value.conversation_id)
        if (value.message != null) ChatMessage.ADAPTER.encodeWithTag(writer, 2, value.message)
