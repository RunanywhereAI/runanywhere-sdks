...
public class LoraAdapterImportRequest(
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<LoraAdapterImportRequest> = object :
        ProtoAdapter<LoraAdapterImportRequest>(
      ...
      override fun encodedSize(`value`: LoraAdapterImportRequest): Int {
        ...
        if (value.source_path != "") size += ProtoAdapter.STRING.encodedSizeWithTag(1,
            value.source_path)
      ...
      override fun encode(writer: ProtoWriter, `value`: LoraAdapterImportRequest) {
        if (value.source_path != "") ProtoAdapter.STRING.encodeWithTag(writer, 1, value.source_path)
