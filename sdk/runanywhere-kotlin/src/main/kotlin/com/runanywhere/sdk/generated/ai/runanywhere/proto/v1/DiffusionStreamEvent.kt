...
public class DiffusionStreamEvent(
  ...
  public val kind: DiffusionStreamEventKind =
  ...
  ): DiffusionStreamEvent = DiffusionStreamEvent(seq, timestamp_us, request_id, kind, progress,
      result, error_message, error_code, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<DiffusionStreamEvent> = object :
        ProtoAdapter<DiffusionStreamEvent>(
      ...
      override fun encodedSize(`value`: DiffusionStreamEvent): Int {
        ...
        if (value.request_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(3,
            value.request_id)
        if (value.kind != DiffusionStreamEventKind.DIFFUSION_STREAM_EVENT_KIND_UNSPECIFIED) size +=
            DiffusionStreamEventKind.ADAPTER.encodedSizeWithTag(4, value.kind)
      ...
      override fun encode(writer: ProtoWriter, `value`: DiffusionStreamEvent) {
        ...
        if (value.kind != DiffusionStreamEventKind.DIFFUSION_STREAM_EVENT_KIND_UNSPECIFIED)
      ...
      override fun decode(reader: ProtoReader): DiffusionStreamEvent {
        ...
        var kind: DiffusionStreamEventKind =
            DiffusionStreamEventKind.DIFFUSION_STREAM_EVENT_KIND_UNSPECIFIED
