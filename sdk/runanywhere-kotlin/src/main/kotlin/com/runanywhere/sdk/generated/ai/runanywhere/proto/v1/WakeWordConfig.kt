...
public class WakeWordConfig(
  ...
  ): WakeWordConfig = WakeWordConfig(model_id, keyword, threshold, pre_roll_ms, sample_rate_hz, type_kind, unknownFields)
    ...
    public val ADAPTER: ProtoAdapter<WakeWordConfig> = object : ProtoAdapter<WakeWordConfig>(
      ...
      override fun encodedSize(`value`: WakeWordConfig): Int {
        ...
        if (!value.threshold.equals(0f)) {
          size += ProtoAdapter.FLOAT.encodedSizeWithTag(3, value.threshold)
        }
        if (value.pre_roll_ms != 0) {
          size += ProtoAdapter.INT32.encodedSizeWithTag(4, value.pre_roll_ms)
        }
      ...
      override fun encode(writer: ProtoWriter, `value`: WakeWordConfig) {
        ...
        if (!value.threshold.equals(0f)) {
          ProtoAdapter.FLOAT.encodeWithTag(writer, 3, value.threshold)
        }
        if (value.pre_roll_ms != 0) {
          ProtoAdapter.INT32.encodeWithTag(writer, 4, value.pre_roll_ms)
        }
        if (value.sample_rate_hz != 0) {
