...
public class VADAudioSource(
  ...
  ): VADAudioSource = VADAudioSource(audio_data, adapter_handle, encoding, sample_rate, channels,
      frame_offset_ms, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<VADAudioSource> = object : ProtoAdapter<VADAudioSource>(
      ...
      override fun encodedSize(`value`: VADAudioSource): Int {
        ...
        if (value.encoding != VADAudioEncoding.VAD_AUDIO_ENCODING_UNSPECIFIED) size +=
            VADAudioEncoding.ADAPTER.encodedSizeWithTag(3, value.encoding)
        ...
        if (value.frame_offset_ms != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(6,
            value.frame_offset_ms)
        return size
      }

      override fun encode(writer: ProtoWriter, `value`: VADAudioSource) {
        if (value.encoding != VADAudioEncoding.VAD_AUDIO_ENCODING_UNSPECIFIED)
        ...
        if (value.frame_offset_ms != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 6,
            value.frame_offset_ms)
