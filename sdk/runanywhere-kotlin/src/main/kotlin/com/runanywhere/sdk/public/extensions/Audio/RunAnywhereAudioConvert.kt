 ...
 * Thin wrappers over commons `rac_audio_pcm16_to_float32` so callers feeding
 * raw Int16 microphone PCM into `RunAnywhere.detectVoiceActivity(...)` /
 * `transcribe(...)` do not reimplement the normalisation.
 */
