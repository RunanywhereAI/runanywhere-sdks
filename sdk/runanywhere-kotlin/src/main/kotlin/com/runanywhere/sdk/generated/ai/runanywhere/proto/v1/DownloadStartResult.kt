...
public class DownloadStartResult(
  ...
  public val failure_reason: DownloadFailureReason =
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      error_message, resume_token, failure_reason, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<DownloadStartResult> = object :
        ProtoAdapter<DownloadStartResult>(
      ...
      override fun encodedSize(`value`: DownloadStartResult): Int {
        ...
        if (value.accepted != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(1, value.accepted)
        ...
        if (value.initial_progress != null) size += DownloadProgress.ADAPTER.encodedSizeWithTag(4,
        ...
        if (value.resume_token != "") size += ProtoAdapter.STRING.encodedSizeWithTag(6,
            value.resume_token)
        if (value.failure_reason != DownloadFailureReason.DOWNLOAD_FAILURE_REASON_UNSPECIFIED)
      ...
      override fun encode(writer: ProtoWriter, `value`: DownloadStartResult) {
        if (value.accepted != false) ProtoAdapter.BOOL.encodeWithTag(writer, 1, value.accepted)
      ...
      override fun decode(reader: ProtoReader): DownloadStartResult {
        ...
        var failure_reason: DownloadFailureReason =
            DownloadFailureReason.DOWNLOAD_FAILURE_REASON_UNSPECIFIED
