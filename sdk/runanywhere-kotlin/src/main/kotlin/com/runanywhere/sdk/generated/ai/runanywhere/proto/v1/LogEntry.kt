...
public class LogEntry(
  ...
  ): LogEntry = LogEntry(timestamp_unix_ms, level, category, message, metadata, file_, line,
      function, error_code, model_id, framework, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<LogEntry> = object : ProtoAdapter<LogEntry>(
      ...
      override fun encodedSize(`value`: LogEntry): Int {
        ...
        if (value.timestamp_unix_ms != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(1,
            value.timestamp_unix_ms)
        if (value.level != LogLevel.LOG_LEVEL_TRACE) size += LogLevel.ADAPTER.encodedSizeWithTag(2,
            value.level)
        if (value.category != "") size += ProtoAdapter.STRING.encodedSizeWithTag(3, value.category)
        ...
        if (value.file_ != "") size += ProtoAdapter.STRING.encodedSizeWithTag(6, value.file_)
        if (value.line != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(7, value.line)
        if (value.function != "") size += ProtoAdapter.STRING.encodedSizeWithTag(8, value.function)
        ...
        if (value.framework != "") size += ProtoAdapter.STRING.encodedSizeWithTag(11,
            value.framework)
        return size
      }

      override fun encode(writer: ProtoWriter, `value`: LogEntry) {
        if (value.timestamp_unix_ms != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 1,
            value.timestamp_unix_ms)
        if (value.level != LogLevel.LOG_LEVEL_TRACE) LogLevel.ADAPTER.encodeWithTag(writer, 2,
            value.level)
        if (value.category != "") ProtoAdapter.STRING.encodeWithTag(writer, 3, value.category)
        ...
        if (value.line != 0) ProtoAdapter.INT32.encodeWithTag(writer, 7, value.line)
        if (value.function != "") ProtoAdapter.STRING.encodeWithTag(writer, 8, value.function)
        ...
        if (value.framework != "") ProtoAdapter.STRING.encodeWithTag(writer, 11, value.framework)
