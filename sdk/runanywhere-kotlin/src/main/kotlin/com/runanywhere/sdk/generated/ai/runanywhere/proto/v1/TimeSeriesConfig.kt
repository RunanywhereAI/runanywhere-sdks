...
public class TimeSeriesConfig(
  ...
  ): TimeSeriesConfig = TimeSeriesConfig(anomaly_model_id, llm_model_id, window_size, stride,
      anomaly_threshold, type_kind, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<TimeSeriesConfig> = object : ProtoAdapter<TimeSeriesConfig>(
      ...
      override fun encodedSize(`value`: TimeSeriesConfig): Int {
        ...
        if (value.anomaly_model_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(1,
            value.anomaly_model_id)
        if (value.llm_model_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(2,
            value.llm_model_id)
        if (value.window_size != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(3,
            value.window_size)
        if (value.stride != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(4, value.stride)
        if (!value.anomaly_threshold.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(5,
      ...
      override fun encode(writer: ProtoWriter, `value`: TimeSeriesConfig) {
        if (value.anomaly_model_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 1,
            value.anomaly_model_id)
        if (value.llm_model_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 2,
            value.llm_model_id)
        if (value.window_size != 0) ProtoAdapter.INT32.encodeWithTag(writer, 3, value.window_size)
        if (value.stride != 0) ProtoAdapter.INT32.encodeWithTag(writer, 4, value.stride)
        if (!value.anomaly_threshold.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 5,
            value.anomaly_threshold)
