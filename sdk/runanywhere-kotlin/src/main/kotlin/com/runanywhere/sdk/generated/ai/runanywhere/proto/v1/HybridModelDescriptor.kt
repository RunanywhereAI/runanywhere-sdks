...
public class HybridModelDescriptor(
  ...
  ): HybridModelDescriptor = HybridModelDescriptor(model_id, model_type, backend, provider,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<HybridModelDescriptor> = object :
        ProtoAdapter<HybridModelDescriptor>(
      ...
      override fun encodedSize(`value`: HybridModelDescriptor): Int {
        ...
        if (value.model_type != HybridModelType.HYBRID_MODEL_TYPE_UNSPECIFIED) size +=
            HybridModelType.ADAPTER.encodedSizeWithTag(2, value.model_type)
        if (value.backend != HybridBackendKind.HYBRID_BACKEND_UNSPECIFIED) size +=
            HybridBackendKind.ADAPTER.encodedSizeWithTag(3, value.backend)
      ...
      override fun encode(writer: ProtoWriter, `value`: HybridModelDescriptor) {
        ...
        if (value.model_type != HybridModelType.HYBRID_MODEL_TYPE_UNSPECIFIED)
            HybridModelType.ADAPTER.encodeWithTag(writer, 2, value.model_type)
        if (value.backend != HybridBackendKind.HYBRID_BACKEND_UNSPECIFIED)
