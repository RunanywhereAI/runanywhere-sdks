...
public class SDKEvent(
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      destination, properties, operation_id, correlation_id, source, trace_id, initialization,
      configuration, generation, model, performance, network, storage, framework, device,
      component_init, voice, voice_pipeline, component_lifecycle, session, auth, model_registry,
      download, storage_lifecycle, hardware_routing, capability, telemetry, cancellation, failure,
      unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<SDKEvent> = object : ProtoAdapter<SDKEvent>(
      ...
      override fun encodedSize(`value`: SDKEvent): Int {
        ...
        if (value.operation_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(33,
            value.operation_id)
        if (value.correlation_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(34,
            value.correlation_id)
        if (value.source != "") size += ProtoAdapter.STRING.encodedSizeWithTag(35, value.source)
        if (value.trace_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(36, value.trace_id)
      ...
      override fun encode(writer: ProtoWriter, `value`: SDKEvent) {
        ...
        if (value.operation_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 33,
            value.operation_id)
        if (value.correlation_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 34,
            value.correlation_id)
        if (value.source != "") ProtoAdapter.STRING.encodeWithTag(writer, 35, value.source)
        if (value.trace_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 36, value.trace_id)
