...
public class StoredModel(
  ...
  ): StoredModel = StoredModel(model_id, name, size_bytes, local_path, downloaded_at_ms, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<StoredModel> = object : ProtoAdapter<StoredModel>(
      ...
      override fun encodedSize(`value`: StoredModel): Int {
        ...
        if (value.local_path != "") {
          size += ProtoAdapter.STRING.encodedSizeWithTag(4, value.local_path)
        }
      ...
      override fun encode(writer: ProtoWriter, `value`: StoredModel) {
        ...
        if (value.local_path != "") {
          ProtoAdapter.STRING.encodeWithTag(writer, 4, value.local_path)
        }
