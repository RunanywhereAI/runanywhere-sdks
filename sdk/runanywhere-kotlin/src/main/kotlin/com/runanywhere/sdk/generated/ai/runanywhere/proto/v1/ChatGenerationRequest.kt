...
public class ChatGenerationRequest(
  ...
  ): ChatGenerationRequest = ChatGenerationRequest(request_id, conversation_id, messages, options,
      tool_calling, metadata, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ChatGenerationRequest> = object :
        ProtoAdapter<ChatGenerationRequest>(
      ...
      override fun encodedSize(`value`: ChatGenerationRequest): Int {
        ...
        if (value.request_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(1,
            value.request_id)
        if (value.conversation_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(2,
      ...
      override fun encode(writer: ProtoWriter, `value`: ChatGenerationRequest) {
        ...
        if (value.conversation_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 2,
            value.conversation_id)
