...
public class STTOutput(
  ...
  ): STTOutput = STTOutput(text, confidence, language, words, alternatives, metadata, timestamp_ms, duration_ms, speaker_ids, error_message, error_code, segment_index, unknownFields)
