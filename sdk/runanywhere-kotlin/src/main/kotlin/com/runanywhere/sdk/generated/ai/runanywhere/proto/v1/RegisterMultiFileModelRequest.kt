...
public class RegisterMultiFileModelRequest(
  ...
  ): RegisterMultiFileModelRequest = RegisterMultiFileModelRequest(id, name, framework, files,
      category, format, memory_required_bytes, download_size_bytes, context_length,
      supports_thinking, supports_lora, description, source, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<RegisterMultiFileModelRequest> = object :
        ProtoAdapter<RegisterMultiFileModelRequest>(
      ...
      override fun redact(`value`: RegisterMultiFileModelRequest): RegisterMultiFileModelRequest =
          value.copy(
