...
public class NamedEntity(
  ...
  ): NamedEntity = NamedEntity(text, entity_type, start_offset, end_offset, confidence,
      unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<NamedEntity> = object : ProtoAdapter<NamedEntity>(
      ...
      override fun encodedSize(`value`: NamedEntity): Int {
        ...
        if (value.entity_type != "") size += ProtoAdapter.STRING.encodedSizeWithTag(2,
            value.entity_type)
        if (value.start_offset != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(3,
            value.start_offset)
        if (value.end_offset != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(4,
            value.end_offset)
      ...
      override fun encode(writer: ProtoWriter, `value`: NamedEntity) {
        ...
        if (value.entity_type != "") ProtoAdapter.STRING.encodeWithTag(writer, 2, value.entity_type)
        if (value.start_offset != 0) ProtoAdapter.INT32.encodeWithTag(writer, 3, value.start_offset)
        if (value.end_offset != 0) ProtoAdapter.INT32.encodeWithTag(writer, 4, value.end_offset)
