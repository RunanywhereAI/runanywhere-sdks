...
public class ToolPromptFormatRequest(
  ...
  ): ToolPromptFormatRequest = ToolPromptFormatRequest(user_prompt, options, tool_results,
      assistant_text, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ToolPromptFormatRequest> = object :
        ProtoAdapter<ToolPromptFormatRequest>(
      ...
      override fun encodedSize(`value`: ToolPromptFormatRequest): Int {
        ...
        if (value.user_prompt != "") size += ProtoAdapter.STRING.encodedSizeWithTag(1,
            value.user_prompt)
      ...
      override fun encode(writer: ProtoWriter, `value`: ToolPromptFormatRequest) {
        if (value.user_prompt != "") ProtoAdapter.STRING.encodeWithTag(writer, 1, value.user_prompt)
