...
public class ModelDeleteRequest(
  ...
  ): ModelDeleteRequest = ModelDeleteRequest(model_id, delete_files, unregister, unload_if_loaded,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ModelDeleteRequest> = object :
        ProtoAdapter<ModelDeleteRequest>(
      ...
      override fun encodedSize(`value`: ModelDeleteRequest): Int {
        ...
        if (value.delete_files != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(2,
            value.delete_files)
        if (value.unregister != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(3,
            value.unregister)
      ...
      override fun encode(writer: ProtoWriter, `value`: ModelDeleteRequest) {
        ...
        if (value.delete_files != false) ProtoAdapter.BOOL.encodeWithTag(writer, 2,
            value.delete_files)
        if (value.unregister != false) ProtoAdapter.BOOL.encodeWithTag(writer, 3, value.unregister)
