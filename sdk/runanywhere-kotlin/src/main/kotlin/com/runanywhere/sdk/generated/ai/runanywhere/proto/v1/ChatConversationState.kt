...
public class ChatConversationState(
  ...
  ): ChatConversationState = ChatConversationState(conversation_id, messages, created_at_ms,
      updated_at_ms, metadata, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ChatConversationState> = object :
        ProtoAdapter<ChatConversationState>(
      ...
      override fun encodedSize(`value`: ChatConversationState): Int {
        ...
        if (value.conversation_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(1,
      ...
      override fun encode(writer: ProtoWriter, `value`: ChatConversationState) {
        if (value.conversation_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 1,
            value.conversation_id)
