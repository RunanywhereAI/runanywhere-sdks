...
public class VADStreamEvent(
  ...
  ): VADStreamEvent = VADStreamEvent(seq, timestamp_us, request_id, kind, result, activity,
      statistics, error_message, error_code, unknownFields)
    ...
    public val ADAPTER: ProtoAdapter<VADStreamEvent> = object : ProtoAdapter<VADStreamEvent>(
      ...
      override fun encodedSize(`value`: VADStreamEvent): Int {
        ...
        if (value.request_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(3,
            value.request_id)
        if (value.kind != VADStreamEventKind.VAD_STREAM_EVENT_KIND_UNSPECIFIED) size +=
            VADStreamEventKind.ADAPTER.encodedSizeWithTag(4, value.kind)
      ...
      override fun encode(writer: ProtoWriter, `value`: VADStreamEvent) {
        ...
        if (value.kind != VADStreamEventKind.VAD_STREAM_EVENT_KIND_UNSPECIFIED)
