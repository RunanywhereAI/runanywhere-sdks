    ...
    public val ADAPTER: ProtoAdapter<ModelLoadResult> = object : ProtoAdapter<ModelLoadResult>(
      ...
      override fun encodedSize(`value`: ModelLoadResult): Int {
        ...
        if (value.framework != InferenceFramework.INFERENCE_FRAMEWORK_UNSPECIFIED) size +=
            InferenceFramework.ADAPTER.encodedSizeWithTag(4, value.framework)
        if (value.resolved_path != "") size += ProtoAdapter.STRING.encodedSizeWithTag(5,
            value.resolved_path)
        if (value.loaded_at_unix_ms != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(6,
      ...
      override fun encode(writer: ProtoWriter, `value`: ModelLoadResult) {
        ...
        if (value.resolved_path != "") ProtoAdapter.STRING.encodeWithTag(writer, 5,
            value.resolved_path)
