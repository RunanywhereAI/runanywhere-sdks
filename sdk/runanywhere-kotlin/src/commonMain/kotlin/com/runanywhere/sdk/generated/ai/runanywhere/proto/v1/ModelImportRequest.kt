...
public class ModelImportRequest(
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ModelImportRequest> = object :
        ProtoAdapter<ModelImportRequest>(
      ...
      override fun encodedSize(`value`: ModelImportRequest): Int {
        ...
        if (value.source_path != "") size += ProtoAdapter.STRING.encodedSizeWithTag(2,
            value.source_path)
        if (value.copy_into_managed_storage != false) size +=
            ProtoAdapter.BOOL.encodedSizeWithTag(3, value.copy_into_managed_storage)
      ...
      override fun encode(writer: ProtoWriter, `value`: ModelImportRequest) {
        ...
        if (value.source_path != "") ProtoAdapter.STRING.encodeWithTag(writer, 2, value.source_path)
        if (value.copy_into_managed_storage != false) ProtoAdapter.BOOL.encodeWithTag(writer, 3,
            value.copy_into_managed_storage)
