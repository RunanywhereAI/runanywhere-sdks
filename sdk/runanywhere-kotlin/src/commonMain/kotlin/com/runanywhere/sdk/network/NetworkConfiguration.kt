...
data class NetworkConfiguration(
     ...
     */
    class Builder(config: NetworkConfiguration = NetworkConfiguration()) {
        ...
        fun retryDelay(baseDelayMs: Long, maxDelayMs: Long = this.maxRetryDelayMs) = apply {
        ...
        fun connectionPool(maxIdle: Int, keepAlive: Long) = apply {
        ...
        fun caching(enabled: Boolean, sizeBytes: Long = this.cacheSizeBytes, directory: String? = this.cacheDirectory) = apply {
        ...
        fun logging(enabled: Boolean, level: NetworkLogLevel = NetworkLogLevel.INFO) = apply {
        ...
        fun redirects(follow: Boolean, maxRedirects: Int = this.maxRedirects) = apply {
    ...
    companion object {
         ...
         */
        fun production() = NetworkConfiguration(
            maxRetryAttempts = 3,
            enableLogging = false,
         ...
         */
        fun development() = NetworkConfiguration(
         ...
         */
        fun testing() = NetworkConfiguration(
