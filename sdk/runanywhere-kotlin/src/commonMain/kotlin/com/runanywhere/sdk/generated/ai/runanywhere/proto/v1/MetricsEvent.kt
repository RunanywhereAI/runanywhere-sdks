  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<MetricsEvent> = object : ProtoAdapter<MetricsEvent>(
      ...
      override fun encodedSize(`value`: MetricsEvent): Int {
        ...
        if (!value.stt_final_ms.equals(0.0)) size += ProtoAdapter.DOUBLE.encodedSizeWithTag(1,
            value.stt_final_ms)
        if (!value.llm_first_token_ms.equals(0.0)) size += ProtoAdapter.DOUBLE.encodedSizeWithTag(2,
            value.llm_first_token_ms)
        if (!value.tts_first_audio_ms.equals(0.0)) size += ProtoAdapter.DOUBLE.encodedSizeWithTag(3,
            value.tts_first_audio_ms)
        if (!value.end_to_end_ms.equals(0.0)) size += ProtoAdapter.DOUBLE.encodedSizeWithTag(4,
            value.end_to_end_ms)
        if (value.tokens_generated != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(5,
            value.tokens_generated)
        if (value.audio_samples_played != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(6,
      ...
      override fun encode(writer: ProtoWriter, `value`: MetricsEvent) {
        if (!value.stt_final_ms.equals(0.0)) ProtoAdapter.DOUBLE.encodeWithTag(writer, 1,
            value.stt_final_ms)
        if (!value.llm_first_token_ms.equals(0.0)) ProtoAdapter.DOUBLE.encodeWithTag(writer, 2,
            value.llm_first_token_ms)
        if (!value.tts_first_audio_ms.equals(0.0)) ProtoAdapter.DOUBLE.encodeWithTag(writer, 3,
            value.tts_first_audio_ms)
        if (!value.end_to_end_ms.equals(0.0)) ProtoAdapter.DOUBLE.encodeWithTag(writer, 4,
            value.end_to_end_ms)
        if (value.tokens_generated != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 5,
            value.tokens_generated)
