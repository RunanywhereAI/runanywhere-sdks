...
public class VoiceAgentComposeConfig(
  ...
  override fun toString(): String {
    ...
    if (wakeword_model_path != null) result +=
        """wakeword_model_path=${sanitize(wakeword_model_path)}"""
    ...
    if (wakeword_embedding_model_path != null) result +=
        """wakeword_embedding_model_path=${sanitize(wakeword_embedding_model_path)}"""
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<VoiceAgentComposeConfig> = object :
        ProtoAdapter<VoiceAgentComposeConfig>(
      ...
      override fun encodedSize(`value`: VoiceAgentComposeConfig): Int {
        ...
        if (value.vad_sample_rate != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(10,
            value.vad_sample_rate)
        if (!value.vad_frame_length.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(11,
            value.vad_frame_length)
        if (!value.vad_energy_threshold.equals(0f)) size +=
            ProtoAdapter.FLOAT.encodedSizeWithTag(12, value.vad_energy_threshold)
        if (value.wakeword_enabled != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(13,
        ...
        if (!value.wakeword_threshold.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(17,
            value.wakeword_threshold)
      ...
      override fun encode(writer: ProtoWriter, `value`: VoiceAgentComposeConfig) {
        ...
        if (value.vad_sample_rate != 0) ProtoAdapter.INT32.encodeWithTag(writer, 10,
            value.vad_sample_rate)
        if (!value.vad_frame_length.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 11,
            value.vad_frame_length)
        if (!value.vad_energy_threshold.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 12,
            value.vad_energy_threshold)
        if (value.wakeword_enabled != false) ProtoAdapter.BOOL.encodeWithTag(writer, 13,
            value.wakeword_enabled)
        ...
        if (!value.wakeword_threshold.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 17,
            value.wakeword_threshold)
