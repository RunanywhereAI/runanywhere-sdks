  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<DiffusionProgress> = object : ProtoAdapter<DiffusionProgress>(
      ...
      override fun encodedSize(`value`: DiffusionProgress): Int {
        ...
        if (!value.progress_percent.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(1,
            value.progress_percent)
        if (value.current_step != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(2,
            value.current_step)
        if (value.total_steps != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(3,
            value.total_steps)
      ...
      override fun encode(writer: ProtoWriter, `value`: DiffusionProgress) {
        if (!value.progress_percent.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 1,
            value.progress_percent)
        if (value.current_step != 0) ProtoAdapter.INT32.encodeWithTag(writer, 2, value.current_step)
