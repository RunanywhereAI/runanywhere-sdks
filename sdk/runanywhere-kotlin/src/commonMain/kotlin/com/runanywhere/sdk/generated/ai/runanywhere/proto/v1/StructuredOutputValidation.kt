...
public class StructuredOutputValidation(
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<StructuredOutputValidation> = object :
        ProtoAdapter<StructuredOutputValidation>(
      ...
      override fun encodedSize(`value`: StructuredOutputValidation): Int {
        ...
        if (value.contains_json != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(2,
            value.contains_json)
      ...
      override fun redact(`value`: StructuredOutputValidation): StructuredOutputValidation =
          value.copy(
