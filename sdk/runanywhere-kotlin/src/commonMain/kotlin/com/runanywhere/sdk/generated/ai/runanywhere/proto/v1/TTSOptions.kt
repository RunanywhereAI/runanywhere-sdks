  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<TTSOptions> = object : ProtoAdapter<TTSOptions>(
      ...
      override fun encodedSize(`value`: TTSOptions): Int {
        ...
        if (value.voice != "") size += ProtoAdapter.STRING.encodedSizeWithTag(1, value.voice)
        if (value.language_code != "") size += ProtoAdapter.STRING.encodedSizeWithTag(2,
            value.language_code)
        if (!value.speaking_rate.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(3,
            value.speaking_rate)
        if (!value.pitch.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(4, value.pitch)
        if (!value.volume.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(5, value.volume)
        if (value.enable_ssml != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(6,
            value.enable_ssml)
      ...
      override fun encode(writer: ProtoWriter, `value`: TTSOptions) {
        if (value.voice != "") ProtoAdapter.STRING.encodeWithTag(writer, 1, value.voice)
        if (value.language_code != "") ProtoAdapter.STRING.encodeWithTag(writer, 2,
            value.language_code)
        if (!value.speaking_rate.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 3,
            value.speaking_rate)
        if (!value.pitch.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 4, value.pitch)
        if (!value.volume.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 5, value.volume)
