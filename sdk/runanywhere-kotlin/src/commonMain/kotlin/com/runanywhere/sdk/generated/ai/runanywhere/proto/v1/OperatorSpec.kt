  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<OperatorSpec> = object : ProtoAdapter<OperatorSpec>(
      ...
      override fun encodedSize(`value`: OperatorSpec): Int {
        ...
        if (value.pinned_engine != "") size += ProtoAdapter.STRING.encodedSizeWithTag(4,
            value.pinned_engine)
        if (value.model_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(5, value.model_id)
        if (value.device != DeviceAffinity.DEVICE_AFFINITY_UNSPECIFIED) size +=
            DeviceAffinity.ADAPTER.encodedSizeWithTag(6, value.device)
        return size
      }
      ...
      override fun encode(writer: ProtoWriter, `value`: OperatorSpec) {
        ...
        if (value.pinned_engine != "") ProtoAdapter.STRING.encodeWithTag(writer, 4,
            value.pinned_engine)
        if (value.model_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 5, value.model_id)
        if (value.device != DeviceAffinity.DEVICE_AFFINITY_UNSPECIFIED)
