  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<ModelImportResult> = object : ProtoAdapter<ModelImportResult>(
      ...
      override fun encodedSize(`value`: ModelImportResult): Int {
        ...
        if (value.local_path != "") size += ProtoAdapter.STRING.encodedSizeWithTag(3,
            value.local_path)
        if (value.imported_bytes != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(4,
            value.imported_bytes)
      ...
      override fun encode(writer: ProtoWriter, `value`: ModelImportResult) {
        ...
        if (value.local_path != "") ProtoAdapter.STRING.encodeWithTag(writer, 3, value.local_path)
        if (value.imported_bytes != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 4,
            value.imported_bytes)
