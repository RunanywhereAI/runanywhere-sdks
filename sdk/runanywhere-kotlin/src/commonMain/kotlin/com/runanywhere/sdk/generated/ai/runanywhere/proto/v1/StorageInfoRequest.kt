  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<StorageInfoRequest> = object :
      ...
      override fun encodedSize(`value`: StorageInfoRequest): Int {
        ...
        if (value.include_device != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(1,
            value.include_device)
        if (value.include_app != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(2,
            value.include_app)
      ...
      override fun encode(writer: ProtoWriter, `value`: StorageInfoRequest) {
        if (value.include_device != false) ProtoAdapter.BOOL.encodeWithTag(writer, 1,
            value.include_device)
