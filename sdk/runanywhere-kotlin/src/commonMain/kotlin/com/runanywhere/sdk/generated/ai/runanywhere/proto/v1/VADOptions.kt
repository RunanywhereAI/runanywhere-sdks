  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<VADOptions> = object : ProtoAdapter<VADOptions>(
      ...
      override fun encodedSize(`value`: VADOptions): Int {
        ...
        if (!value.threshold.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(1,
            value.threshold)
        if (value.min_speech_duration_ms != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(2,
            value.min_speech_duration_ms)
        if (value.min_silence_duration_ms != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(3,
            value.min_silence_duration_ms)
        return size
      }

      override fun encode(writer: ProtoWriter, `value`: VADOptions) {
        if (!value.threshold.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 1,
            value.threshold)
        if (value.min_speech_duration_ms != 0) ProtoAdapter.INT32.encodeWithTag(writer, 2,
            value.min_speech_duration_ms)
