...
public class ModelStorageMetrics(
  ...
  ): ModelStorageMetrics = ModelStorageMetrics(model_id, size_on_disk_bytes, last_used_ms,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ModelStorageMetrics> = object :
        ProtoAdapter<ModelStorageMetrics>(
      ...
      override fun encodedSize(`value`: ModelStorageMetrics): Int {
        ...
        if (value.size_on_disk_bytes != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(2,
            value.size_on_disk_bytes)
      ...
      override fun encode(writer: ProtoWriter, `value`: ModelStorageMetrics) {
        ...
        if (value.size_on_disk_bytes != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 2,
            value.size_on_disk_bytes)
