  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<DownloadFilePlan> = object : ProtoAdapter<DownloadFilePlan>(
      ...
      override fun encodedSize(`value`: DownloadFilePlan): Int {
        ...
        if (value.file_ != null) size += ModelFileDescriptor.ADAPTER.encodedSizeWithTag(1,
            value.file_)
        if (value.storage_key != "") size += ProtoAdapter.STRING.encodedSizeWithTag(2,
            value.storage_key)
        if (value.destination_path != "") size += ProtoAdapter.STRING.encodedSizeWithTag(3,
            value.destination_path)
        if (value.expected_bytes != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(4,
      ...
      override fun encode(writer: ProtoWriter, `value`: DownloadFilePlan) {
        if (value.file_ != null) ModelFileDescriptor.ADAPTER.encodeWithTag(writer, 1, value.file_)
        if (value.storage_key != "") ProtoAdapter.STRING.encodeWithTag(writer, 2, value.storage_key)
        if (value.destination_path != "") ProtoAdapter.STRING.encodeWithTag(writer, 3,
            value.destination_path)
        if (value.expected_bytes != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 4,
            value.expected_bytes)
