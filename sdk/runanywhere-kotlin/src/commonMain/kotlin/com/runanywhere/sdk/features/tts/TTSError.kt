...
sealed class TTSError : Exception() {
    ...
    data class InvalidSpeakingRate(
        val value: Float,
    ) : TTSError() {
    ...
    data class AudioFormatNotSupported(
        val format: String,
    ) : TTSError() {
