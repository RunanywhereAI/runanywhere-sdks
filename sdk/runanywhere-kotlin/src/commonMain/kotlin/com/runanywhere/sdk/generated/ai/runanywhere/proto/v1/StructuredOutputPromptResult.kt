...
public class StructuredOutputPromptResult(
  ...
  ): StructuredOutputPromptResult = StructuredOutputPromptResult(prepared_prompt, system_prompt,
      json_schema, regex_pattern, grammar, error_message, error_code, unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<StructuredOutputPromptResult> = object :
        ProtoAdapter<StructuredOutputPromptResult>(
      ...
      override fun encodedSize(`value`: StructuredOutputPromptResult): Int {
        ...
        if (value.prepared_prompt != "") size += ProtoAdapter.STRING.encodedSizeWithTag(1,
      ...
      override fun encode(writer: ProtoWriter, `value`: StructuredOutputPromptResult) {
        if (value.prepared_prompt != "") ProtoAdapter.STRING.encodeWithTag(writer, 1,
            value.prepared_prompt)
      ...
      override fun redact(`value`: StructuredOutputPromptResult): StructuredOutputPromptResult =
          value.copy(
