...
data class TTSConfiguration(
     ...
     */
    class Builder(private var voice: String = DEFAULT_VOICE) {
...
data class TTSOptions(
    ...
    companion object {
        ...
        fun from(configuration: TTSConfiguration) = TTSOptions(
            ...
            sampleRate = if (configuration.audioFormat == AudioFormat.PCM)
...
data class TTSSpeakResult(
    ...
    companion object {
        ...
        internal fun from(output: TTSOutput) = TTSSpeakResult(
