  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<ToolParameter> = object : ProtoAdapter<ToolParameter>(
      ...
      override fun encodedSize(`value`: ToolParameter): Int {
        ...
        if (value.type != ToolParameterType.TOOL_PARAMETER_TYPE_UNSPECIFIED) size +=
            ToolParameterType.ADAPTER.encodedSizeWithTag(2, value.type)
      ...
      override fun encode(writer: ProtoWriter, `value`: ToolParameter) {
        ...
        if (value.type != ToolParameterType.TOOL_PARAMETER_TYPE_UNSPECIFIED)
