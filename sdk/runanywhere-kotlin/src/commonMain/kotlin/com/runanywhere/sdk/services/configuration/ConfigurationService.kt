...
class ConfigurationService(
     ...
     */
    override suspend fun loadConfigurationOnLaunch(apiKey: String): ConfigurationData =
        mutex.withLock {
     ...
     */
    override suspend fun setConsumerConfiguration(config: ConfigurationData) =
        mutex.withLock {
            val repository = configRepository
            if (repository == null) {
     ...
     */
    override suspend fun updateConfiguration(updates: (ConfigurationData) -> ConfigurationData) =
        mutex.withLock {
     ...
     */
    override suspend fun getCurrentConfiguration(): ConfigurationData? = currentConfig
     ...
     */
    override suspend fun loadConfigurationWithFallback(apiKey: String): ConfigurationData = loadConfigurationOnLaunch(apiKey)
