...
public class StorageAvailabilityResult(
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<StorageAvailabilityResult> = object :
        ProtoAdapter<StorageAvailabilityResult>(
      ...
      override fun encodedSize(`value`: StorageAvailabilityResult): Int {
        ...
        if (value.availability != null) size += StorageAvailability.ADAPTER.encodedSizeWithTag(2,
            value.availability)
      ...
      override fun encode(writer: ProtoWriter, `value`: StorageAvailabilityResult) {
        ...
        if (value.availability != null) StorageAvailability.ADAPTER.encodeWithTag(writer, 2,
            value.availability)
