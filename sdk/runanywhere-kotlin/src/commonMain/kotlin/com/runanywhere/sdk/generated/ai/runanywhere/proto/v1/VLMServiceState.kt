...
public class VLMServiceState(
  ...
  override fun toString(): String {
    ...
    if (vision_encoder_type != null) result +=
        """vision_encoder_type=${sanitize(vision_encoder_type)}"""
  ...
  ): VLMServiceState = VLMServiceState(is_ready, current_model, context_length, supports_streaming,
      supports_multiple_images, vision_encoder_type, error_message, error_code, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<VLMServiceState> = object : ProtoAdapter<VLMServiceState>(
      ...
      override fun encodedSize(`value`: VLMServiceState): Int {
        ...
        if (value.is_ready != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(1, value.is_ready)
        size += ProtoAdapter.STRING.encodedSizeWithTag(2, value.current_model)
        if (value.context_length != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(3,
            value.context_length)
        if (value.supports_streaming != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(4,
            value.supports_streaming)
        if (value.supports_multiple_images != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(5,
      ...
      override fun encode(writer: ProtoWriter, `value`: VLMServiceState) {
        if (value.is_ready != false) ProtoAdapter.BOOL.encodeWithTag(writer, 1, value.is_ready)
        ProtoAdapter.STRING.encodeWithTag(writer, 2, value.current_model)
        if (value.context_length != 0) ProtoAdapter.INT32.encodeWithTag(writer, 3,
            value.context_length)
        if (value.supports_streaming != false) ProtoAdapter.BOOL.encodeWithTag(writer, 4,
            value.supports_streaming)
        if (value.supports_multiple_images != false) ProtoAdapter.BOOL.encodeWithTag(writer, 5,
            value.supports_multiple_images)
