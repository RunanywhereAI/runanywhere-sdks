...
public class DiffusionConfiguration(
  ...
  public val model_variant: DiffusionModelVariant =
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<DiffusionConfiguration> = object :
        ProtoAdapter<DiffusionConfiguration>(
      ...
      override fun encodedSize(`value`: DiffusionConfiguration): Int {
        ...
        if (value.model_variant != DiffusionModelVariant.DIFFUSION_MODEL_VARIANT_UNSPECIFIED)
            size += DiffusionModelVariant.ADAPTER.encodedSizeWithTag(1, value.model_variant)
        if (value.tokenizer_source != null) size +=
            DiffusionTokenizerSource.ADAPTER.encodedSizeWithTag(2, value.tokenizer_source)
        if (value.enable_safety_checker != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(3,
      ...
      override fun encode(writer: ProtoWriter, `value`: DiffusionConfiguration) {
        ...
        if (value.tokenizer_source != null) DiffusionTokenizerSource.ADAPTER.encodeWithTag(writer,
            2, value.tokenizer_source)
      ...
      override fun decode(reader: ProtoReader): DiffusionConfiguration {
        var model_variant: DiffusionModelVariant =
            DiffusionModelVariant.DIFFUSION_MODEL_VARIANT_UNSPECIFIED
