  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<TTSConfiguration> = object : ProtoAdapter<TTSConfiguration>(
      ...
      override fun encodedSize(`value`: TTSConfiguration): Int {
        ...
        if (value.voice != "") size += ProtoAdapter.STRING.encodedSizeWithTag(2, value.voice)
        if (value.language_code != "") size += ProtoAdapter.STRING.encodedSizeWithTag(3,
            value.language_code)
        if (!value.speaking_rate.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(4,
            value.speaking_rate)
        if (!value.pitch.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(5, value.pitch)
        if (!value.volume.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(6, value.volume)
        ...
        if (value.sample_rate != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(8,
            value.sample_rate)
        if (value.enable_neural_voice != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(9,
      ...
      override fun encode(writer: ProtoWriter, `value`: TTSConfiguration) {
        ...
        if (value.voice != "") ProtoAdapter.STRING.encodeWithTag(writer, 2, value.voice)
        if (value.language_code != "") ProtoAdapter.STRING.encodeWithTag(writer, 3,
            value.language_code)
        if (!value.speaking_rate.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 4,
            value.speaking_rate)
        if (!value.pitch.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 5, value.pitch)
        if (!value.volume.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 6, value.volume)
