...
public class ChatAttachment(
  ...
  ): ChatAttachment = ChatAttachment(id, media_type, data_, uri, adapter_handle, name, size_bytes,
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<ChatAttachment> = object : ProtoAdapter<ChatAttachment>(
      ...
      override fun encodedSize(`value`: ChatAttachment): Int {
        ...
        if (value.media_type != "") size += ProtoAdapter.STRING.encodedSizeWithTag(2,
            value.media_type)
      ...
      override fun encode(writer: ProtoWriter, `value`: ChatAttachment) {
        ...
        if (value.media_type != "") ProtoAdapter.STRING.encodeWithTag(writer, 2, value.media_type)
