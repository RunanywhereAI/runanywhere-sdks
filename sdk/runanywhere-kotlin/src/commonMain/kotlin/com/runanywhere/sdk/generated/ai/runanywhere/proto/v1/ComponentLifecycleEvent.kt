...
public class ComponentLifecycleEvent(
  ...
  public val previous_state: ComponentLifecycleState =
  ...
  public val current_state: ComponentLifecycleState =
      ComponentLifecycleState.COMPONENT_LIFECYCLE_STATE_UNSPECIFIED,
  @field:WireField(
    tag = 4,
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ComponentLifecycleEvent> = object :
        ProtoAdapter<ComponentLifecycleEvent>(
      ...
      override fun encodedSize(`value`: ComponentLifecycleEvent): Int {
        ...
        if (value.previous_state != ComponentLifecycleState.COMPONENT_LIFECYCLE_STATE_UNSPECIFIED)
            size += ComponentLifecycleState.ADAPTER.encodedSizeWithTag(2, value.previous_state)
        if (value.current_state != ComponentLifecycleState.COMPONENT_LIFECYCLE_STATE_UNSPECIFIED)
            size += ComponentLifecycleState.ADAPTER.encodedSizeWithTag(3, value.current_state)
        if (value.model_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(4, value.model_id)
      ...
      override fun encode(writer: ProtoWriter, `value`: ComponentLifecycleEvent) {
        ...
        if (value.model_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 4, value.model_id)
      ...
      override fun decode(reader: ProtoReader): ComponentLifecycleEvent {
        ...
        var previous_state: ComponentLifecycleState =
            ComponentLifecycleState.COMPONENT_LIFECYCLE_STATE_UNSPECIFIED
        var current_state: ComponentLifecycleState =
            ComponentLifecycleState.COMPONENT_LIFECYCLE_STATE_UNSPECIFIED
        var model_id: String = ""
