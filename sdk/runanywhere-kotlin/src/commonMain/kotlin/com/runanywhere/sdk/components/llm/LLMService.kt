...
/**
 * LlamaCpp Service Provider implementation
 */
class LlamaCppServiceProvider : BaseLLMServiceProvider() {
    override val name: String = "LlamaCpp"
    override val framework: LLMFramework = com.runanywhere.sdk.models.enums.LLMFramework.LLAMA_CPP
    ...
    override fun canHandle(modelId: String?): Boolean {
        if (!super.canHandle(modelId)) return false

        // Additional LlamaCpp-specific checks
...
/**
 * Expect/actual LlamaCpp service implementation
 */
