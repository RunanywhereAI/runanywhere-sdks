  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<ModelDeleteResult> = object : ProtoAdapter<ModelDeleteResult>(
      ...
      override fun encodedSize(`value`: ModelDeleteResult): Int {
        ...
        if (value.deleted_bytes != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(3,
            value.deleted_bytes)
        if (value.files_deleted != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(4,
            value.files_deleted)
        if (value.registry_updated != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(5,
            value.registry_updated)
        if (value.was_loaded != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(6,
            value.was_loaded)
      ...
      override fun encode(writer: ProtoWriter, `value`: ModelDeleteResult) {
        ...
        if (value.deleted_bytes != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 3,
            value.deleted_bytes)
        if (value.files_deleted != false) ProtoAdapter.BOOL.encodeWithTag(writer, 4,
            value.files_deleted)
        if (value.registry_updated != false) ProtoAdapter.BOOL.encodeWithTag(writer, 5,
            value.registry_updated)
