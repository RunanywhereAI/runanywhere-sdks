...
public class DownloadPlanRequest(
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<DownloadPlanRequest> = object :
        ProtoAdapter<DownloadPlanRequest>(
      ...
      override fun encodedSize(`value`: DownloadPlanRequest): Int {
        ...
        if (value.resume_existing != false) size += ProtoAdapter.BOOL.encodedSizeWithTag(3,
      ...
      override fun encode(writer: ProtoWriter, `value`: DownloadPlanRequest) {
        ...
        if (value.resume_existing != false) ProtoAdapter.BOOL.encodeWithTag(writer, 3,
            value.resume_existing)
