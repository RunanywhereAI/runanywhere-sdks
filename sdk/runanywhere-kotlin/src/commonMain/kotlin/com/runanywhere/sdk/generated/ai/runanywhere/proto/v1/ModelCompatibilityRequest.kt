...
public class ModelCompatibilityRequest(
  ...
  override fun toString(): String {
    ...
    if (accelerator_preference != null) result +=
  ...
  public fun copy(
    ...
    unknownFields: ByteString = this.unknownFields,
      ...
      available_ram_bytes, available_storage_bytes, accelerator_preference, preferred_framework,
      unknownFields)

  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ModelCompatibilityRequest> = object :
        ProtoAdapter<ModelCompatibilityRequest>(
      ...
      override fun encodedSize(`value`: ModelCompatibilityRequest): Int {
        ...
        if (value.available_ram_bytes != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(3,
      ...
      override fun redact(`value`: ModelCompatibilityRequest): ModelCompatibilityRequest =
          value.copy(
