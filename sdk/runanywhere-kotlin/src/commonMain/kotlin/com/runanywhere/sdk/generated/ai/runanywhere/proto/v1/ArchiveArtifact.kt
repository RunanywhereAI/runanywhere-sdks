  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<ArchiveArtifact> = object : ProtoAdapter<ArchiveArtifact>(
      ...
      override fun encodedSize(`value`: ArchiveArtifact): Int {
        ...
        if (value.type != ArchiveType.ARCHIVE_TYPE_UNSPECIFIED) size +=
            ArchiveType.ADAPTER.encodedSizeWithTag(1, value.type)
        if (value.structure != ArchiveStructure.ARCHIVE_STRUCTURE_UNSPECIFIED) size +=
      ...
      override fun encode(writer: ProtoWriter, `value`: ArchiveArtifact) {
        if (value.type != ArchiveType.ARCHIVE_TYPE_UNSPECIFIED)
