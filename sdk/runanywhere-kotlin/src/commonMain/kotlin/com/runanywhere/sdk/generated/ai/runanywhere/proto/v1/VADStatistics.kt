  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<VADStatistics> = object : ProtoAdapter<VADStatistics>(
      ...
      override fun encodedSize(`value`: VADStatistics): Int {
        ...
        if (!value.current_energy.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(1,
            value.current_energy)
        if (!value.current_threshold.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(2,
            value.current_threshold)
        if (!value.ambient_level.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(3,
            value.ambient_level)
        if (!value.recent_avg.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(4,
            value.recent_avg)
      ...
      override fun encode(writer: ProtoWriter, `value`: VADStatistics) {
        if (!value.current_energy.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 1,
            value.current_energy)
        if (!value.current_threshold.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 2,
            value.current_threshold)
        if (!value.ambient_level.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 3,
            value.ambient_level)
