  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<VLMResult> = object : ProtoAdapter<VLMResult>(
      ...
      override fun encodedSize(`value`: VLMResult): Int {
        ...
        if (value.prompt_tokens != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(2,
            value.prompt_tokens)
        if (value.completion_tokens != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(3,
            value.completion_tokens)
        if (value.total_tokens != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(4,
            value.total_tokens)
        if (value.processing_time_ms != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(5,
      ...
      override fun encode(writer: ProtoWriter, `value`: VLMResult) {
        ...
        if (value.prompt_tokens != 0) ProtoAdapter.INT32.encodeWithTag(writer, 2,
            value.prompt_tokens)
        if (value.completion_tokens != 0) ProtoAdapter.INT32.encodeWithTag(writer, 3,
            value.completion_tokens)
        if (value.total_tokens != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 4,
            value.total_tokens)
