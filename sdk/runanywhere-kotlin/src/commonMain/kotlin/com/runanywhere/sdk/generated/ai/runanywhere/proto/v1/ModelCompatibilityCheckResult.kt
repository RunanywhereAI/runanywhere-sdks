...
// Source: runanywhere.v1.ModelCompatibilityCheckResult in model_types.proto
...
public class ModelCompatibilityCheckResult(
  /**
...
) : Message<ModelCompatibilityCheckResult, Nothing>(ADAPTER, unknownFields) {
  /**
  ...
  override fun equals(other: Any?): Boolean {
    ...
    if (other !is ModelCompatibilityCheckResult) return false
  ...
  override fun toString(): String {
    ...
    return result.joinToString(prefix = "ModelCompatibilityCheckResult{", separator = ", ", postfix
        = "}")
  }
  ...
  ): ModelCompatibilityCheckResult = ModelCompatibilityCheckResult(is_compatible, can_run, can_fit,
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ModelCompatibilityCheckResult> = object :
        ProtoAdapter<ModelCompatibilityCheckResult>(
      FieldEncoding.LENGTH_DELIMITED, 
      ModelCompatibilityCheckResult::class, 
      "type.googleapis.com/runanywhere.v1.ModelCompatibilityCheckResult", 
      PROTO_3, 
      null, 
      "model_types.proto"
    ) {
      override fun encodedSize(`value`: ModelCompatibilityCheckResult): Int {
      ...
      override fun encode(writer: ProtoWriter, `value`: ModelCompatibilityCheckResult) {
      ...
      override fun encode(writer: ReverseProtoWriter, `value`: ModelCompatibilityCheckResult) {
        writer.writeBytes(value.unknownFields)
        if (value.error_message != "") ProtoAdapter.STRING.encodeWithTag(writer, 12,
            value.error_message)
        if (value.error_code != 0) ProtoAdapter.INT32.encodeWithTag(writer, 11, value.error_code)
      ...
      override fun decode(reader: ProtoReader): ModelCompatibilityCheckResult {
        ...
        return ModelCompatibilityCheckResult(
      ...
      override fun redact(`value`: ModelCompatibilityCheckResult): ModelCompatibilityCheckResult =
          value.copy(
