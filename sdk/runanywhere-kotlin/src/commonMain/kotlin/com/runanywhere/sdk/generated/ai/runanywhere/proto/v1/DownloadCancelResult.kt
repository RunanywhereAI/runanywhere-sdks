...
public class DownloadCancelResult(
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<DownloadCancelResult> = object :
        ProtoAdapter<DownloadCancelResult>(
      ...
      override fun encodedSize(`value`: DownloadCancelResult): Int {
        ...
        if (value.partial_bytes_deleted != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(4,
