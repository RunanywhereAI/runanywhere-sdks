  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<DownloadProgress> = object : ProtoAdapter<DownloadProgress>(
      ...
      override fun encodedSize(`value`: DownloadProgress): Int {
        ...
        if (value.stage != DownloadStage.DOWNLOAD_STAGE_UNSPECIFIED) size +=
            DownloadStage.ADAPTER.encodedSizeWithTag(2, value.stage)
        if (value.bytes_downloaded != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(3,
            value.bytes_downloaded)
        if (value.total_bytes != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(4,
            value.total_bytes)
        if (!value.stage_progress.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(5,
            value.stage_progress)
        if (!value.overall_speed_bps.equals(0f)) size += ProtoAdapter.FLOAT.encodedSizeWithTag(6,
            value.overall_speed_bps)
        if (value.eta_seconds != 0L) size += ProtoAdapter.INT64.encodedSizeWithTag(7,
            value.eta_seconds)
        if (value.state != DownloadState.DOWNLOAD_STATE_UNSPECIFIED) size +=
            DownloadState.ADAPTER.encodedSizeWithTag(8, value.state)
        if (value.retry_attempt != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(9,
            value.retry_attempt)
      ...
      override fun encode(writer: ProtoWriter, `value`: DownloadProgress) {
        ...
        if (value.stage != DownloadStage.DOWNLOAD_STAGE_UNSPECIFIED)
            DownloadStage.ADAPTER.encodeWithTag(writer, 2, value.stage)
        if (value.bytes_downloaded != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 3,
            value.bytes_downloaded)
        if (value.total_bytes != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 4, value.total_bytes)
        if (!value.stage_progress.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 5,
            value.stage_progress)
        if (!value.overall_speed_bps.equals(0f)) ProtoAdapter.FLOAT.encodeWithTag(writer, 6,
            value.overall_speed_bps)
        if (value.eta_seconds != 0L) ProtoAdapter.INT64.encodeWithTag(writer, 7, value.eta_seconds)
        if (value.state != DownloadState.DOWNLOAD_STATE_UNSPECIFIED)
