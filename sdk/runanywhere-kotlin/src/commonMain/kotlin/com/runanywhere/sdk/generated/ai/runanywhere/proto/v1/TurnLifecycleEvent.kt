...
public class TurnLifecycleEvent(
  ...
  public val kind: TurnLifecycleEventKind =
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<TurnLifecycleEvent> = object :
        ProtoAdapter<TurnLifecycleEvent>(
      ...
      override fun encodedSize(`value`: TurnLifecycleEvent): Int {
        ...
        if (value.kind != TurnLifecycleEventKind.TURN_LIFECYCLE_EVENT_KIND_UNSPECIFIED) size +=
            TurnLifecycleEventKind.ADAPTER.encodedSizeWithTag(1, value.kind)
        if (value.turn_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(2, value.turn_id)
        if (value.session_id != "") size += ProtoAdapter.STRING.encodedSizeWithTag(3,
            value.session_id)
        if (value.transcript != "") size += ProtoAdapter.STRING.encodedSizeWithTag(4,
            value.transcript)
      ...
      override fun encode(writer: ProtoWriter, `value`: TurnLifecycleEvent) {
        if (value.kind != TurnLifecycleEventKind.TURN_LIFECYCLE_EVENT_KIND_UNSPECIFIED)
            TurnLifecycleEventKind.ADAPTER.encodeWithTag(writer, 1, value.kind)
        if (value.turn_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 2, value.turn_id)
        if (value.session_id != "") ProtoAdapter.STRING.encodeWithTag(writer, 3, value.session_id)
      ...
      override fun decode(reader: ProtoReader): TurnLifecycleEvent {
        var kind: TurnLifecycleEventKind =
            TurnLifecycleEventKind.TURN_LIFECYCLE_EVENT_KIND_UNSPECIFIED
        var turn_id: String = ""
