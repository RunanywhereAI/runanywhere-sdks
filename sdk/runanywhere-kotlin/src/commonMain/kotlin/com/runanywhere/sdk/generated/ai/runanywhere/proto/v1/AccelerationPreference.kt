...
// Source: runanywhere.v1.AccelerationPreference in model_types.proto
...
public enum class AccelerationPreference(
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<AccelerationPreference> = object :
        EnumAdapter<AccelerationPreference>(
      AccelerationPreference::class, 
      PROTO_3, 
      AccelerationPreference.ACCELERATION_PREFERENCE_UNSPECIFIED
    ) {
      override fun fromValue(`value`: Int): AccelerationPreference? =
          AccelerationPreference.fromValue(`value`)
    }
