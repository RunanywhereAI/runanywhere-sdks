...
class ModelLoadingService(
     ...
     */
    suspend fun loadModel(modelId: String): LoadedModelWithService =
        withContext(Dispatchers.Default) {
            ...
            val provider =
                ModuleRegistry.llmProvider(modelId)
            ...
            val configuration =
                com.runanywhere.sdk.features.llm.LLMConfiguration(
     ...
     */
    fun getLoadedModel(modelId: String): LoadedModelWithService? = loadedModels[modelId]
     ...
     */
    fun getAllLoadedModels(): List<LoadedModelWithService> = loadedModels.values.toList()
