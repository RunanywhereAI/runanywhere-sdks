...
public class ModelDiscoveryResult(
  ...
  public val discovered_models: List<DiscoveredModel> = immutableCopyOf("discovered_models",
      discovered_models)
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<ModelDiscoveryResult> = object :
        ProtoAdapter<ModelDiscoveryResult>(
      ...
      override fun encodedSize(`value`: ModelDiscoveryResult): Int {
        ...
        if (value.linked_count != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(3,
            value.linked_count)
        if (value.purged_count != 0) size += ProtoAdapter.INT32.encodedSizeWithTag(4,
            value.purged_count)
      ...
      override fun encode(writer: ProtoWriter, `value`: ModelDiscoveryResult) {
        ...
        if (value.linked_count != 0) ProtoAdapter.INT32.encodeWithTag(writer, 3, value.linked_count)
        if (value.purged_count != 0) ProtoAdapter.INT32.encodeWithTag(writer, 4, value.purged_count)
