/**
 * RunAnywhere Core WhisperCPP Module
 *
 * This module provides the whisper.cpp backend adapter for RunAnywhere Core.
 * It is PURE KOTLIN - no native libraries are bundled here.
 *
 * Architecture (mirrors iOS WhisperCPPRuntime):
 *   iOS:     WhisperCPPRuntime.swift -> CRunAnywhereCore -> RunAnywhereCoreBinary.xcframework
 *   Android: WhisperCPPAdapter.kt -> RunAnywhereBridge.kt -> runanywhere-core-native AAR
 *
 * This module provides:
 *   - WhisperCPPServiceProvider - Service provider implementation for STT
 *   - WhisperCPPCoreService - Core service bridging to native code
 *
 * Native libraries are provided transitively via:
 *   runanywhere-core-whispercpp -> main SDK -> runanywhere-core-native
 */
...
android {
    namespace = "com.runanywhere.sdk.core.whispercpp"
    compileSdk = 36
...
publishing {
    publications.withType<MavenPublication> {
        pom {
            name.set("RunAnywhere Core WhisperCPP Module")
            description.set("whisper.cpp backend adapter for RunAnywhere SDK (pure Kotlin)")
