...
Verified state: 2026-07-12 against the 0.20.15 package architecture.
...
All four backend packages depend on `runanywhere ^0.20.15`. The core package vendors `RACommons` (C++ library); backend packages vendor their own XCFrameworks/`.so` files.
...
|---|---|
| `runanywhere` (Dart package) | 0.20.15 |
| `runanywhere_llamacpp` | 0.20.15 |
| `runanywhere_mlx` | 0.20.15 |
| `runanywhere_onnx` | 0.20.15 |
| `runanywhere_qhexrt` | 0.20.15 |
| `RACommons` native | 0.1.6 |
| QHexRT native | private staged artifact |
| llama.cpp engine | b7199 |
| ONNX Runtime | 1.24.3 |
| Canonical version source | `sdk/runanywhere-commons/VERSION` (0.20.15) |
