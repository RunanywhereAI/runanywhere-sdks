...
const SolutionType$json = {
  ...
  '2': [
    ...
    {'1': 'SOLUTION_TYPE_VOICE_AGENT', '2': 1},
    {'1': 'SOLUTION_TYPE_RAG', '2': 2},
    {'1': 'SOLUTION_TYPE_WAKEWORD', '2': 3},
    {'1': 'SOLUTION_TYPE_TIME_SERIES', '2': 4},
    {'1': 'SOLUTION_TYPE_AGENT_LOOP', '2': 5},
  ],
};
...
final $typed_data.Uint8List solutionTypeDescriptor = $convert.base64Decode(
    'CgxTb2x1dGlvblR5cGUSHQoZU09MVVRJT05fVFlQRV9VTlNQRUNJRklFRBAAEh0KGVNPTFVUSU'
    '9OX1RZUEVfVk9JQ0VfQUdFTlQQARIVChFTT0xVVElPTl9UWVBFX1JBRxACEhoKFlNPTFVUSU9O'
    'X1RZUEVfV0FLRVdPUkQQAxIdChlTT0xVVElPTl9UWVBFX1RJTUVfU0VSSUVTEAQSHAoYU09MVV'
    'RJT05fVFlQRV9BR0VOVF9MT09QEAU=');
...
const SolutionHandle$json = {
  '1': 'SolutionHandle',
  '2': [
    {'1': 'handle_id', '3': 1, '4': 1, '5': 9, '10': 'handleId'},
    {'1': 'solution_type', '3': 2, '4': 1, '5': 9, '10': 'solutionType'},
    {'1': 'created_at_ms', '3': 3, '4': 1, '5': 3, '10': 'createdAtMs'},
    {'1': 'state', '3': 4, '4': 1, '5': 9, '9': 0, '10': 'state', '17': true},
  ],
  '8': [
    {'1': '_state'},
  ],
...
final $typed_data.Uint8List solutionHandleDescriptor = $convert.base64Decode(
    'Cg5Tb2x1dGlvbkhhbmRsZRIbCgloYW5kbGVfaWQYASABKAlSCGhhbmRsZUlkEiMKDXNvbHV0aW'
    '9uX3R5cGUYAiABKAlSDHNvbHV0aW9uVHlwZRIiCg1jcmVhdGVkX2F0X21zGAMgASgDUgtjcmVh'
    'dGVkQXRNcxIZCgVzdGF0ZRgEIAEoCUgAUgVzdGF0ZYgBAUIICgZfc3RhdGU=');
...
const VoiceAgentConfig$json = {
  ...
  '2': [
    ...
    {'1': 'type_kind', '3': 16, '4': 1, '5': 14, '6': '.runanywhere.v1.SolutionType', '9': 0, '10': 'typeKind', '17': true},
  ],
  '8': [
    {'1': '_type_kind'},
  ],
...
final $typed_data.Uint8List voiceAgentConfigDescriptor = $convert.base64Decode(
    ...
    'DGVtaXRQYXJ0aWFscxIjCg1lbWl0X3Rob3VnaHRzGA4gASgIUgxlbWl0VGhvdWdodHMSPgoJdH'
    'lwZV9raW5kGBAgASgOMhwucnVuYW55d2hlcmUudjEuU29sdXRpb25UeXBlSABSCHR5cGVLaW5k'
    'iAEBQgwKCl90eXBlX2tpbmQ=');
...
const RAGConfig$json = {
  ...
  '2': [
    ...
    {'1': 'type_kind', '3': 12, '4': 1, '5': 14, '6': '.runanywhere.v1.SolutionType', '9': 0, '10': 'typeKind', '17': true},
  ],
  '8': [
    {'1': '_type_kind'},
  ],
...
final $typed_data.Uint8List rAGConfigDescriptor = $convert.base64Decode(
    ...
    '5wcm9tcHRUZW1wbGF0ZRI+Cgl0eXBlX2tpbmQYDCABKA4yHC5ydW5hbnl3aGVyZS52MS5Tb2x1'
    'dGlvblR5cGVIAFIIdHlwZUtpbmSIAQFCDAoKX3R5cGVfa2luZA==');
...
const WakeWordConfig$json = {
  ...
  '2': [
    ...
    {'1': 'sample_rate_hz', '3': 5, '4': 1, '5': 5, '10': 'sampleRateHz'},
    {'1': 'type_kind', '3': 6, '4': 1, '5': 14, '6': '.runanywhere.v1.SolutionType', '9': 0, '10': 'typeKind', '17': true},
  ],
  '8': [
    {'1': '_type_kind'},
  ],
...
final $typed_data.Uint8List wakeWordConfigDescriptor = $convert.base64Decode(
    ...
    'VIehI+Cgl0eXBlX2tpbmQYBiABKA4yHC5ydW5hbnl3aGVyZS52MS5Tb2x1dGlvblR5cGVIAFII'
    'dHlwZUtpbmSIAQFCDAoKX3R5cGVfa2luZA==');
...
final $typed_data.Uint8List agentLoopConfigDescriptor = $convert.base64Decode(
    ...
    'RlcmF0aW9ucxIsChJtYXhfY29udGV4dF90b2tlbnMYBSABKAVSEG1heENvbnRleHRUb2tlbnMS'
    'PgoJdHlwZV9raW5kGAYgASgOMhwucnVuYW55d2hlcmUudjEuU29sdXRpb25UeXBlSABSCHR5cG'
    'VLaW5kiAEBQgwKCl90eXBlX2tpbmQ=');
