...
class STTConfiguration extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(10)
  $core.bool get enableWordTimestamps => $_getBF(6);
  @$pb.TagNumber(10)
  set enableWordTimestamps($core.bool value) => $_setBool(6, value);
  @$pb.TagNumber(10)
  $core.bool hasEnableWordTimestamps() => $_has(6);
  @$pb.TagNumber(10)
...
class STTOptions extends $pb.GeneratedMessage {
  factory STTOptions({
    ...
    final result = create();
    if (enablePunctuation != null) result.enablePunctuation = enablePunctuation;
    if (diarize != null) result.diarize = diarize;
    if (speakersExpected != null) result.speakersExpected = speakersExpected;
    if (enableWordTimestamps != null)
      result.enableWordTimestamps = enableWordTimestamps;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(3, _omitFieldNames ? '' : 'diarize')
    ..aI(4, _omitFieldNames ? '' : 'speakersExpected')
    ..aOB(6, _omitFieldNames ? '' : 'enableWordTimestamps')
    ..aI(14, _omitFieldNames ? '' : 'silenceDurationMs')
  ...
  @$pb.TagNumber(3)
  $core.bool hasDiarize() => $_has(1);
  @$pb.TagNumber(3)
  void clearDiarize() => $_clearField(3);

  /// Hint for how many distinct speakers to expect. AssemblyAI
  /// `speakers_expected`. Unset = let the engine decide.
  @$pb.TagNumber(4)
  $core.int get speakersExpected => $_getIZ(2);
  @$pb.TagNumber(4)
  set speakersExpected($core.int value) => $_setSignedInt32(2, value);
  @$pb.TagNumber(4)
  $core.bool hasSpeakersExpected() => $_has(2);
  @$pb.TagNumber(4)
  void clearSpeakersExpected() => $_clearField(4);

  @$pb.TagNumber(6)
  $core.bool get enableWordTimestamps => $_getBF(3);
  @$pb.TagNumber(6)
  set enableWordTimestamps($core.bool value) => $_setBool(3, value);
  @$pb.TagNumber(6)
  $core.bool hasEnableWordTimestamps() => $_has(3);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(14)
  void clearSilenceDurationMs() => $_clearField(14);
...
enum STTAudioSource_Source { audioData, fileUri, notSet }
