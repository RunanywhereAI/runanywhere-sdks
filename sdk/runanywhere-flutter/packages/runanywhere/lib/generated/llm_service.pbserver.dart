...
import 'llm_service.pb.dart' as $6;
import 'llm_service.pbjson.dart';

export 'llm_service.pb.dart';

abstract class LLMServiceBase extends $pb.GeneratedService {
  $async.Future<$6.LLMStreamEvent> generate($pb.ServerContext ctx, $6.LLMGenerateRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'Generate': return $6.LLMGenerateRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      case 'Generate': return this.generate(ctx, request as $6.LLMGenerateRequest);
      default: throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
