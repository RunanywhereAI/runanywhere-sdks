...
class SolutionHandle extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SolutionHandle', package: const $pb.PackageName(_omitMessageNames ? '' : 'runanywhere.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SolutionHandle copyWith(void Function(SolutionHandle) updates) => super.copyWith((message) => updates(message as SolutionHandle)) as SolutionHandle;
...
class RAGConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RAGConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'runanywhere.v1'), createEmptyInstance: create)
    ...
    ..e<SolutionType>(12, _omitFieldNames ? '' : 'typeKind', $pb.PbFieldType.OE, defaultOrMaker: SolutionType.SOLUTION_TYPE_UNSPECIFIED, valueOf: SolutionType.valueOf, enumValues: SolutionType.values)
    ..hasRequiredFields = false
  ;
...
class WakeWordConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WakeWordConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'runanywhere.v1'), createEmptyInstance: create)
    ...
    ..a<$core.int>(5, _omitFieldNames ? '' : 'sampleRateHz', $pb.PbFieldType.O3)
    ..e<SolutionType>(6, _omitFieldNames ? '' : 'typeKind', $pb.PbFieldType.OE, defaultOrMaker: SolutionType.SOLUTION_TYPE_UNSPECIFIED, valueOf: SolutionType.valueOf, enumValues: SolutionType.values)
    ..hasRequiredFields = false
  ;
