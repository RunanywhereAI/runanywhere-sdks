...
class ModuleRegistry {
  ...
  ///
  /// Matches iOS `ModuleRegistry.register(_: M.Type, priority:)` pattern.
  /// Stores module metadata and strategies. Service provider registration
  /// is handled separately by the module's static `register()` method.
  ///
  ...
  void registerModule(RunAnywhereModule module, {int? priority}) {
    ...
    // Store metadata (matches iOS pattern)
