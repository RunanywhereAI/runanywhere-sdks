...
#                        Expected: PATH/*.xcframework and/or canonical Android
#                        ownership roots PATH/<abi>/{jni,llamacpp,onnx}/*.so.
...
# Public pub packages use the pinned remote-download/checksum contract. The
