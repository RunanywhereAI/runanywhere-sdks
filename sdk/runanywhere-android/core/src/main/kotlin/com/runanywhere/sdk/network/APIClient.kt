...
class APIClient(
    ...
    override suspend fun postRaw(endpoint: String, payload: ByteArray, requiresAuth: Boolean): ByteArray = mutex.withLock {
        ...
        try {
            ...
            logger.error("POST raw request failed: $endpoint", e)
            throw when (e) {
                is SDKError -> e
    ...
    override suspend fun getRaw(endpoint: String, requiresAuth: Boolean): ByteArray = mutex.withLock {
        ...
        try {
            ...
            logger.error("GET raw request failed: $endpoint", e)
            throw when (e) {
                is SDKError -> e
    ...
    override suspend fun downloadFile(
        ...
        try {
            ...
            logger.error("File download failed: $url", e)
            throw when (e) {
                is SDKError -> e
    ...
    override suspend fun isNetworkAvailable(): Boolean {
        return try {
            ...
            logger.error("Failed to check network availability", e)
            false
        }
    }
    ...
    override suspend fun getNetworkType(): String {
        return try {
            ...
            logger.error("Failed to get network type", e)
            "unknown"
        }
    }
