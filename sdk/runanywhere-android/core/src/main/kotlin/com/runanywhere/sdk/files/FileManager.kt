...
class FileManager(private val context: Context) {
     ...
     */
    suspend fun getModelPath(modelId: String): File = mutex.withLock {
     ...
     */
    suspend fun getCachePath(key: String): File = mutex.withLock {
     ...
     */
    suspend fun writeFile(path: String, data: ByteArray): Boolean = mutex.withLock {
     ...
     */
    suspend fun readFile(path: String): ByteArray? = mutex.withLock {
     ...
     */
    suspend fun deleteFile(path: String): Boolean = mutex.withLock {
     ...
     */
    suspend fun getFileSize(path: String): Long = mutex.withLock {
        return try {
            val file = File(path)
            ...
            tempDir.walkTopDown()
                ...
                .forEach { file ->
                    try {
                        ...
                        logger.warn("Failed to delete old file: ${file.absolutePath}", e)
                    }
                }
            ...
            cacheDir.walkTopDown()
                ...
                .forEach { file ->
                    try {
                        ...
                        logger.warn("Failed to delete old cache file: ${file.absolutePath}", e)
                    }
                }
    ...
    private fun calculateDirectorySize(directory: File): Long {
        return try {
            ...
            logger.warn("Failed to calculate directory size: ${directory.absolutePath}", e)
            0L
        }
    }
}
