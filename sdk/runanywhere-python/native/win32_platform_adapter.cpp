...
// Ported verbatim from runanywhere-electron; symbol renamed to
// rac_python_fill_win32_adapter and the DPAPI description bound to
// "runanywhere-python".
#ifndef NOMINMAX
#define NOMINMAX
#endif
...
// Set once by rac_python_fill_win32_adapter before rac_init(); read-only after,
...
rac_result_t win_secure_set(const char* key, const char* value, void*) {
    ...
    DATA_BLOB out{0, nullptr};
    if (!CryptProtectData(&in, L"runanywhere-python", nullptr, nullptr, nullptr,
                          CRYPTPROTECT_UI_FORBIDDEN, &out)) {
        return RAC_ERROR_SECURE_STORAGE_FAILED;
    }
