...
class VoiceAgentConfig(_message.Message):
    __slots__ = ("llm_model_id", "stt_model_id", "tts_model_id", "vad_model_id", "sample_rate_hz", "chunk_ms", "audio_source", "audio_file_path", "enable_barge_in", "barge_in_threshold_ms", "system_prompt", "max_context_tokens", "temperature", "emit_partials", "emit_thoughts")
...
class RAGConfig(_message.Message):
    __slots__ = ("embed_model_id", "rerank_model_id", "llm_model_id", "vector_store", "vector_store_path", "retrieve_k", "rerank_top", "bm25_k1", "bm25_b", "rrf_k", "prompt_template")
...
class WakeWordConfig(_message.Message):
    __slots__ = ("model_id", "keyword", "threshold", "pre_roll_ms", "sample_rate_hz")
    ...
    pre_roll_ms: int
    sample_rate_hz: int
    def __init__(self, model_id: _Optional[str] = ..., keyword: _Optional[str] = ..., threshold: _Optional[float] = ..., pre_roll_ms: _Optional[int] = ..., sample_rate_hz: _Optional[int] = ...) -> None: ...

class AgentLoopConfig(_message.Message):
    __slots__ = ("llm_model_id", "system_prompt", "tools", "max_iterations", "max_context_tokens")
    LLM_MODEL_ID_FIELD_NUMBER: _ClassVar[int]
    SYSTEM_PROMPT_FIELD_NUMBER: _ClassVar[int]
    ...
    max_iterations: int
    max_context_tokens: int
    def __init__(self, llm_model_id: _Optional[str] = ..., system_prompt: _Optional[str] = ..., tools: _Optional[_Iterable[_Union[ToolSpec, _Mapping]]] = ..., max_iterations: _Optional[int] = ..., max_context_tokens: _Optional[int] = ...) -> None: ...
...
class TimeSeriesConfig(_message.Message):
    __slots__ = ("anomaly_model_id", "llm_model_id", "window_size", "stride", "anomaly_threshold")
    ...
    def __init__(self, anomaly_model_id: _Optional[str] = ..., llm_model_id: _Optional[str] = ..., window_size: _Optional[int] = ..., stride: _Optional[int] = ..., anomaly_threshold: _Optional[float] = ...) -> None: ...
