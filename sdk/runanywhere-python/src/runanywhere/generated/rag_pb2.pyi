...
class RAGConfiguration(_message.Message):
    __slots__ = ("embedding_model_path", "llm_model_path", "embedding_dimension", "top_k", "similarity_threshold", "chunk_size", "chunk_overlap")
    ...
    chunk_size: int
    chunk_overlap: int
    def __init__(self, embedding_model_path: _Optional[str] = ..., llm_model_path: _Optional[str] = ..., embedding_dimension: _Optional[int] = ..., top_k: _Optional[int] = ..., similarity_threshold: _Optional[float] = ..., chunk_size: _Optional[int] = ..., chunk_overlap: _Optional[int] = ...) -> None: ...
...
class RAGSearchResult(_message.Message):
    __slots__ = ("chunk_id", "text", "similarity_score", "source_document", "metadata")
    ...
    def __init__(self, chunk_id: _Optional[str] = ..., text: _Optional[str] = ..., similarity_score: _Optional[float] = ..., source_document: _Optional[str] = ..., metadata: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class RAGStatistics(_message.Message):
    __slots__ = ("indexed_documents", "indexed_chunks", "total_tokens_indexed", "last_updated_ms", "index_path")
    ...
    last_updated_ms: int
    index_path: str
    def __init__(self, indexed_documents: _Optional[int] = ..., indexed_chunks: _Optional[int] = ..., total_tokens_indexed: _Optional[int] = ..., last_updated_ms: _Optional[int] = ..., index_path: _Optional[str] = ...) -> None: ...
