...
class ChatMessage(_message.Message):
    __slots__ = ("id", "role", "content", "timestamp_us", "name", "tool_calls_json", "tool_call_id")
    ...
    tool_call_id: str
    def __init__(self, id: _Optional[str] = ..., role: _Optional[_Union[MessageRole, str]] = ..., content: _Optional[str] = ..., timestamp_us: _Optional[int] = ..., name: _Optional[str] = ..., tool_calls_json: _Optional[_Iterable[str]] = ..., tool_call_id: _Optional[str] = ...) -> None: ...
