...
public enum TokenCounter {
    ...
    /// - Parameters:
    ///   - fullText: The full generated text
    ///   - thinkingContent: Extracted thinking content (if any)
    ///   - responseContent: The response content without thinking
    /// - Returns: Token count result with breakdown
