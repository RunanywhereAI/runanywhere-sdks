...
public nonisolated enum RAErrorCode: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  case featureNotEnabled // = 323

  /// RAC_ERROR_QUOTA_EXCEEDED
  case quotaExceeded // = 324
  ...
  public init?(rawValue: Int) {
    ...
    case 323: self = .featureNotEnabled
    case 324: self = .quotaExceeded
  ...
  public var rawValue: Int {
    ...
    case .featureNotEnabled: return 323
    case .quotaExceeded: return 324
