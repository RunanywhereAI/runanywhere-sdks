...
public nonisolated struct RAVLMLoadResolvedArtifactsRequest: Sendable {
  ...
  public var primaryModelPath: String = String()

  public var mmprojPath: String {
    get {_mmprojPath ?? String()}
    set {_mmprojPath = newValue}
  }
  /// Returns true if `mmprojPath` has been explicitly set.
  public var hasMmprojPath: Bool {self._mmprojPath != nil}
  /// Clears the value of `mmprojPath`. Subsequent reads from it will return its default value.
  public mutating func clearMmprojPath() {self._mmprojPath = nil}
...
nonisolated extension RAVLMLoadResolvedArtifactsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.modelID) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.primaryModelPath) }()
      case 3: try { try decoder.decodeSingularStringField(value: &self._mmprojPath) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.primaryModelPath.isEmpty {
      try visitor.visitSingularStringField(value: self.primaryModelPath, fieldNumber: 2)
    }
    try { if let v = self._mmprojPath {
      try visitor.visitSingularStringField(value: v, fieldNumber: 3)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: RAVLMLoadResolvedArtifactsRequest, rhs: RAVLMLoadResolvedArtifactsRequest) -> Bool {
    if lhs.modelID != rhs.modelID {return false}
    if lhs.primaryModelPath != rhs.primaryModelPath {return false}
    if lhs._mmprojPath != rhs._mmprojPath {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
nonisolated extension RAVLMLoadResolvedArtifactsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: RAVLMLoadResolvedArtifactsResponse, rhs: RAVLMLoadResolvedArtifactsResponse) -> Bool {
