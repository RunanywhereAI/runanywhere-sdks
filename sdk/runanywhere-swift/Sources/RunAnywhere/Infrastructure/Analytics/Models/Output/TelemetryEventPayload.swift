...
public struct TelemetryEventPayload: Codable, Sendable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        // Use encodeIfPresent for all optional fields to avoid sending null values
        // to backends that don't have the corresponding columns (e.g., Supabase)
        ...
        try container.encodeIfPresent(timeToFirstTokenMs, forKey: .timeToFirstTokenMs)
        try container.encodeIfPresent(promptEvalTimeMs, forKey: .promptEvalTimeMs)
        try container.encodeIfPresent(generationTimeMs, forKey: .generationTimeMs)
        ...
        try container.encodeIfPresent(realTimeFactor, forKey: .realTimeFactor)
        ...
        try container.encodeIfPresent(charactersPerSecond, forKey: .charactersPerSecond)
        try container.encodeIfPresent(audioSizeBytes, forKey: .audioSizeBytes)
        try container.encodeIfPresent(sampleRate, forKey: .sampleRate)
        try container.encodeIfPresent(voice, forKey: .voice)
        try container.encodeIfPresent(outputDurationMs, forKey: .outputDurationMs)
        try container.encodeIfPresent(modelSizeBytes, forKey: .modelSizeBytes)
        try container.encodeIfPresent(archiveType, forKey: .archiveType)
        try container.encodeIfPresent(speechDurationMs, forKey: .speechDurationMs)
        try container.encodeIfPresent(count, forKey: .count)
        try container.encodeIfPresent(freedBytes, forKey: .freedBytes)
