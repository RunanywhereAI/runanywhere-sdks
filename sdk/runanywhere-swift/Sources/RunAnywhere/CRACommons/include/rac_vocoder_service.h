...
RAC_API rac_result_t rac_vocoder_create(const char *model_id,
                                        rac_handle_t *out_handle);
RAC_API rac_result_t rac_vocoder_initialize(rac_handle_t handle,
                                            const char *model_path);
RAC_API rac_result_t rac_vocoder_vocode(rac_handle_t handle,
                                        const rac_vocoder_input_t *input,
                                        rac_vocoder_result_t *out_result);
RAC_API rac_result_t rac_vocoder_cleanup(rac_handle_t handle);
RAC_API void rac_vocoder_destroy(rac_handle_t handle);
RAC_API rac_result_t rac_vocoder_vocode_lifecycle_proto(
