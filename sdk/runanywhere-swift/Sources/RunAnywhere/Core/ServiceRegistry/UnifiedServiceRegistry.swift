...
public actor UnifiedServiceRegistry {
    ...
    private var adaptersByFramework: [LLMFramework: UnifiedFrameworkAdapter] = [:]

    public init() {}

    /// Register an adapter with priority
    /// Higher priority = preferred selection (default: 100)
    public func register(_ adapter: UnifiedFrameworkAdapter, priority: Int = 100) {
    ...
    public func findAdapters(for model: ModelInfo, modality: FrameworkModality) -> [UnifiedFrameworkAdapter] {
    ...
    public func findBestAdapter(for model: ModelInfo, modality: FrameworkModality) -> UnifiedFrameworkAdapter? {
    ...
    public func getAdapter(for framework: LLMFramework) -> UnifiedFrameworkAdapter? {
    ...
    public func getAllAdapters() -> [UnifiedFrameworkAdapter] {
