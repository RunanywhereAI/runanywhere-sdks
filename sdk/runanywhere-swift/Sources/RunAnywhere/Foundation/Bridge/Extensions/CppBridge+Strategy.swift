...
extension ArchiveType {
    ...
    func toC() -> rac_archive_type_t {
        switch self {
        case .zip:      return RAC_ARCHIVE_TYPE_ZIP
        case .tarBz2:   return RAC_ARCHIVE_TYPE_TAR_BZ2
        case .tarGz:    return RAC_ARCHIVE_TYPE_TAR_GZ
        case .tarXz:    return RAC_ARCHIVE_TYPE_TAR_XZ
        default:        return RAC_ARCHIVE_TYPE_ZIP
        }
    }
    ...
    init?(from cType: rac_archive_type_t) {
        switch cType {
        case RAC_ARCHIVE_TYPE_ZIP:      self = .zip
        case RAC_ARCHIVE_TYPE_TAR_BZ2:  self = .tarBz2
        case RAC_ARCHIVE_TYPE_TAR_GZ:   self = .tarGz
        case RAC_ARCHIVE_TYPE_TAR_XZ:   self = .tarXz
        default:                        return nil
        }
    }
}
