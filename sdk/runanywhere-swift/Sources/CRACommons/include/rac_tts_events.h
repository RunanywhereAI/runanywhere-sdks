...
RAC_API rac_result_t rac_tts_event_synthesis_started(
...
RAC_API rac_result_t rac_tts_event_synthesis_chunk(
    const char* synthesis_id,
    int32_t chunk_size
);
...
RAC_API rac_result_t rac_tts_event_synthesis_failed(
    const char* synthesis_id,
    const char* model_id,
