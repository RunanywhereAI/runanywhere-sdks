...
merge_neurt_backend_slice() {
    ...
    # llm_ops/stt_ops/core stay separate archives and must be folded for SPM consumers.
    local inputs=(
        "${build_root}/engines/neurt/${slice_dir}/librac_backend_neurt.a"
        "${build_root}/engines/neurt/${slice_dir}/librac_neurt_llm_ops.a"
        "${build_root}/engines/neurt/${slice_dir}/librac_neurt_stt_ops.a"
...
merge_neurt_backend_macos_slice() {
    ...
    local inputs=(
        ...
        "${build_root}/engines/neurt/librac_neurt_stt_ops.a"
