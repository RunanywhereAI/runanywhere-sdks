...
// in the TypeScript facade). The secure store is a plaintext file store
// restricted to the owner (0600 files inside a 0700 directory); a real macOS
// Keychain / Linux Secret Service backend is a later upgrade (see the seam
// comment in the .cpp).
