...
export const HardwareProfile = {
  encode(message: HardwareProfile, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.chip !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.totalMemoryBytes = longToNumber(reader.uint64() as Long);
          continue;
        case 5:
          if (tag !== 40) {
            break;
...
export const AcceleratorInfo = {
  encode(message: AcceleratorInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
...
export const HardwareProfileResult = {
  encode(message: HardwareProfileResult, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
