...
export const SdkInitPhase1Request = {
  encode(message: SdkInitPhase1Request, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
...
export const SdkInitPhase2Request = {
  encode(_: SdkInitPhase2Request, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
...
export const SdkInitResult = {
  encode(message: SdkInitResult, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.phase !== 0) {
