...
export const ErrorContext = {
  encode(message: ErrorContext, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    Object.entries(message.metadata).forEach(([key, value]) => {
      ErrorContext_MetadataEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).ldelim();
    });
...
export const ErrorContext_MetadataEntry = {
  encode(message: ErrorContext_MetadataEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
...
export const SDKError = {
  encode(message: SDKError, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.code !== 0) {
    ...
    if (message.context !== undefined) {
      ErrorContext.encode(message.context, writer.uint32(34).fork()).ldelim();
    }
