...
export const VLMImage = {
  encode(message: VLMImage, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.metadata).forEach(([key, value]) => {
      VLMImage_MetadataEntry.encode({ key: key as any, value }, writer.uint32(90).fork()).ldelim();
    });
    return writer;
  },
...
export const VLMImage_MetadataEntry = {
  encode(message: VLMImage_MetadataEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
...
export const VLMGenerationRequest = {
  encode(message: VLMGenerationRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.metadata).forEach(([key, value]) => {
      VLMGenerationRequest_MetadataEntry.encode({ key: key as any, value }, writer.uint32(42).fork()).ldelim();
    });
    return writer;
  },
...
export const VLMGenerationRequest_MetadataEntry = {
  encode(message: VLMGenerationRequest_MetadataEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
...
export const VLMStreamEvent = {
  encode(message: VLMStreamEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.seq !== 0) {
...
export const VLMServiceState = {
  encode(message: VLMServiceState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
