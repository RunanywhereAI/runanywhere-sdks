...
})(SdkInitPhase || (SdkInitPhase = {}));
export function sdkInitPhaseFromJSON(object) {
    switch (object) {
        case 0:
...
export function sdkInitPhaseToJSON(object) {
    switch (object) {
...
})(SdkInitEnvironment || (SdkInitEnvironment = {}));
export function sdkInitEnvironmentFromJSON(object) {
    switch (object) {
        case 0:
...
export function sdkInitEnvironmentToJSON(object) {
    switch (object) {
...
export const SdkInitPhase1Request = {
    ...
    create(base) {
        return SdkInitPhase1Request.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSdkInitPhase1Request();
...
export const SdkInitPhase2Request = {
    ...
    create(base) {
        return SdkInitPhase2Request.fromPartial(base ?? {});
    },
    fromPartial(_) {
        const message = createBaseSdkInitPhase2Request();
        return message;
...
export const SdkInitResult = {
    ...
    fromJSON(object) {
        return {
            ...
            httpConfigured: isSet(object.httpConfigured) ? globalThis.Boolean(object.httpConfigured) : false,
            deviceRegistered: isSet(object.deviceRegistered) ? globalThis.Boolean(object.deviceRegistered) : false,
            linkedModelsCount: isSet(object.linkedModelsCount) ? globalThis.Number(object.linkedModelsCount) : 0,
            discoveredOrphans: isSet(object.discoveredOrphans) ? globalThis.Number(object.discoveredOrphans) : 0,
    ...
    create(base) {
        return SdkInitResult.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseSdkInitResult();
...
//# sourceMappingURL=sdk_init.js.map