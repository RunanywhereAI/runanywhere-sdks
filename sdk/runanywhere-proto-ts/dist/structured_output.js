...
export var StructuredOutputMode;
...
export function structuredOutputModeFromJSON(object) {
    switch (object) {
        case 0:
...
export function structuredOutputModeToJSON(object) {
    switch (object) {
...
export var StructuredOutputStreamEventKind;
...
})(StructuredOutputStreamEventKind || (StructuredOutputStreamEventKind = {}));
export function structuredOutputStreamEventKindFromJSON(object) {
    switch (object) {
        case 0:
...
export function structuredOutputStreamEventKindToJSON(object) {
    switch (object) {
...
export const StructuredOutputParseRequest = {
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.options !== undefined) {
            StructuredOutputOptions.encode(message.options, writer.uint32(26).fork()).ldelim();
        }
        Object.entries(message.metadata).forEach(([key, value]) => {
            StructuredOutputParseRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return StructuredOutputParseRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseStructuredOutputParseRequest();
...
export const StructuredOutputParseRequest_MetadataEntry = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.key !== "") {
            writer.uint32(10).string(message.key);
        }
    ...
    create(base) {
        return StructuredOutputParseRequest_MetadataEntry.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseStructuredOutputParseRequest_MetadataEntry();
        message.key = object.key ?? "";
...
export const StructuredOutputValidationRequest = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.text !== "") {
            writer.uint32(10).string(message.text);
        }
        if (message.options !== undefined) {
            StructuredOutputOptions.encode(message.options, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return StructuredOutputValidationRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseStructuredOutputValidationRequest();
        message.text = object.text ?? "";
...
export const StructuredOutputPromptResult = {
    encode(message, writer = _m0.Writer.create()) {
    ...
    create(base) {
        return StructuredOutputPromptResult.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseStructuredOutputPromptResult();
...
export const StructuredOutputRequest = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.requestId !== "") {
            writer.uint32(10).string(message.requestId);
        }
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            StructuredOutputRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return StructuredOutputRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseStructuredOutputRequest();
        message.requestId = object.requestId ?? "";
...
export const StructuredOutputRequest_MetadataEntry = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.key !== "") {
            writer.uint32(10).string(message.key);
        }
    ...
    create(base) {
        return StructuredOutputRequest_MetadataEntry.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseStructuredOutputRequest_MetadataEntry();
        message.key = object.key ?? "";
...
export const StructuredOutputStreamEvent = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.seq !== 0) {
        ...
        if (message.validation !== undefined) {
            StructuredOutputValidation.encode(message.validation, writer.uint32(58).fork()).ldelim();
        }
        if (message.result !== undefined) {
            StructuredOutputResult.encode(message.result, writer.uint32(66).fork()).ldelim();
        }
        if (message.errorMessage !== undefined) {
    ...
    create(base) {
        return StructuredOutputStreamEvent.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseStructuredOutputStreamEvent();
