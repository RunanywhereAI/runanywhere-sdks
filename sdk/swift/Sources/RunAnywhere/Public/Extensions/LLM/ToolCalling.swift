...
/// JSON-schema-ish parameter type. Sample call sites use `.string`, so
/// this is a dedicated Equatable enum rather than a String.
public enum ToolParameterType: String, Sendable, Codable {
...
public struct ToolParameter: Sendable, Codable {
    ...
    /// Typed-enum overload — main-branch sample spelling.
    public init(name: String, type: ToolParameterType, description: String,
                required: Bool = true) {
        self.init(name: name, type: type.rawValue,
