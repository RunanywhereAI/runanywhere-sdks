...
public struct RAGConfiguration: Sendable {
    ...
    /// Path-based alias — main branch stored paths directly.
    ...
    public init(embeddingModelId: String,
        ...
        self.promptTemplate = ""
        self.embeddingConfigJSON = "{}"
        self.llmConfigJSON = "{}"
    }

    /// Main-branch parity initialiser — path-based.
    public init(embeddingModelPath: String,
                llmModelPath: String,
...
public extension RunAnywhere {
    ...
    static func ragCreatePipeline(config: RAGConfiguration) async throws {
        ...
        let pipeline = try RAGPipeline(config: config,
                                         embedModelPath: embedInfo.localPathString ?? "",
                                         llmModelPath: llmInfo.localPathString ?? "")
