...
exports.HardwareAcceleratorPreferenceResult = exports.HardwareAcceleratorPreferenceRequest = exports.HardwareAcceleratorsRequest = exports.HardwareProfileRequest = exports.HardwareProfileResult = exports.AcceleratorInfo = exports.HardwareProfile = exports.AccelerationPreference = exports.protobufPackage = void 0;
...
exports.HardwareProfileResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.profile !== undefined) {
            exports.HardwareProfile.encode(message.profile, writer.uint32(10).fork()).ldelim();
        }
        for (const v of message.accelerators) {
            exports.AcceleratorInfo.encode(v, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
