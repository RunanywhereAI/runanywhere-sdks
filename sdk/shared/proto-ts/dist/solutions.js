...
exports.SolutionConfig = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.voiceAgent !== undefined) {
            exports.VoiceAgentConfig.encode(message.voiceAgent, writer.uint32(10).fork()).ldelim();
        }
        if (message.rag !== undefined) {
            exports.RAGConfig.encode(message.rag, writer.uint32(18).fork()).ldelim();
        }
        if (message.wakeWord !== undefined) {
            exports.WakeWordConfig.encode(message.wakeWord, writer.uint32(26).fork()).ldelim();
        }
        if (message.agentLoop !== undefined) {
            exports.AgentLoopConfig.encode(message.agentLoop, writer.uint32(34).fork()).ldelim();
        }
        if (message.timeSeries !== undefined) {
            exports.TimeSeriesConfig.encode(message.timeSeries, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            voiceAgent: isSet(object.voiceAgent) ? exports.VoiceAgentConfig.fromJSON(object.voiceAgent) : undefined,
            rag: isSet(object.rag) ? exports.RAGConfig.fromJSON(object.rag) : undefined,
            wakeWord: isSet(object.wakeWord) ? exports.WakeWordConfig.fromJSON(object.wakeWord) : undefined,
            agentLoop: isSet(object.agentLoop) ? exports.AgentLoopConfig.fromJSON(object.agentLoop) : undefined,
            timeSeries: isSet(object.timeSeries) ? exports.TimeSeriesConfig.fromJSON(object.timeSeries) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.AgentLoopConfig = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.tools) {
            exports.ToolSpec.encode(v, writer.uint32(26).fork()).ldelim();
        }
