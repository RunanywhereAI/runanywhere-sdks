...
exports.VLMLoadResolvedArtifactsResponse = exports.VLMLoadResolvedArtifactsRequest = exports.VLMServiceState = exports.VLMStreamEvent = exports.VLMResult = exports.VLMGenerationRequest_MetadataEntry = exports.VLMGenerationRequest = exports.VLMGenerationOptions = exports.VLMConfiguration = exports.VLMImage_MetadataEntry = exports.VLMImage = exports.VLMChatTemplate = exports.VLMStreamEventKind = exports.VLMModelFamily = exports.VLMImageFormat = exports.protobufPackage = void 0;
...
exports.VLMImage = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.VLMImage_MetadataEntry.encode({ key: key, value }, writer.uint32(90).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.VLMGenerationOptions = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.customChatTemplate !== undefined) {
            exports.VLMChatTemplate.encode(message.customChatTemplate, writer.uint32(106).fork()).ldelim();
        }
...
exports.VLMGenerationRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.images) {
            exports.VLMImage.encode(v, writer.uint32(18).fork()).ldelim();
        }
        if (message.options !== undefined) {
            exports.VLMGenerationOptions.encode(message.options, writer.uint32(26).fork()).ldelim();
        }
        if (message.modelId !== undefined) {
            writer.uint32(34).string(message.modelId);
        }
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.VLMGenerationRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.VLMStreamEvent = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.result !== undefined) {
            exports.VLMResult.encode(message.result, writer.uint32(74).fork()).ldelim();
        }
        if (message.errorMessage !== undefined) {
...
exports.VLMLoadResolvedArtifactsRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.modelId !== "") {
            writer.uint32(10).string(message.modelId);
        }
    ...
    create(base) {
        return exports.VLMLoadResolvedArtifactsRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseVLMLoadResolvedArtifactsRequest();
        message.modelId = object.modelId ?? "";
...
exports.VLMLoadResolvedArtifactsResponse = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.handle !== 0) {
    ...
    create(base) {
        return exports.VLMLoadResolvedArtifactsResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseVLMLoadResolvedArtifactsResponse();
