...
exports.DiffusionConfiguration = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.tokenizerSource !== undefined) {
            exports.DiffusionTokenizerSource.encode(message.tokenizerSource, writer.uint32(18).fork()).ldelim();
        }
...
exports.DiffusionConfig = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.configuration !== undefined) {
            exports.DiffusionConfiguration.encode(message.configuration, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            inputImageMediaType: isSet(object.inputImageMediaType)
                ...
                : undefined,
            maskImageMediaType: isSet(object.maskImageMediaType) ? globalThis.String(object.maskImageMediaType) : undefined,
            batchSize: isSet(object.batchSize) ? globalThis.Number(object.batchSize) : 0,
            returnLatents: isSet(object.returnLatents) ? globalThis.Boolean(object.returnLatents) : false,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.DiffusionGenerationRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.options !== undefined) {
            exports.DiffusionGenerationOptions.encode(message.options, writer.uint32(18).fork()).ldelim();
        }
        if (message.modelId !== undefined) {
            writer.uint32(26).string(message.modelId);
        }
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.DiffusionGenerationRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.DiffusionProgress = {
    ...
    fromJSON(object) {
        return {
            ...
            etaMs: isSet(object.etaMs) ? globalThis.Number(object.etaMs) : 0,
...
exports.DiffusionResult = {
    ...
    fromJSON(object) {
        return {
            ...
            imageMediaType: isSet(object.imageMediaType) ? globalThis.String(object.imageMediaType) : undefined,
            batchImages: globalThis.Array.isArray(object?.batchImages)
                ? object.batchImages.map((e) => bytesFromBase64(e))
                : [],
            imagesGenerated: isSet(object.imagesGenerated) ? globalThis.Number(object.imagesGenerated) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.DiffusionStreamEvent = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.progress !== undefined) {
            exports.DiffusionProgress.encode(message.progress, writer.uint32(42).fork()).ldelim();
        }
        if (message.result !== undefined) {
            exports.DiffusionResult.encode(message.result, writer.uint32(50).fork()).ldelim();
        }
        if (message.errorMessage !== undefined) {
...
exports.DiffusionServiceState = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.capabilities !== undefined) {
            exports.DiffusionCapabilities.encode(message.capabilities, writer.uint32(26).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        return {
            ...
            isGenerating: isSet(object.isGenerating) ? globalThis.Boolean(object.isGenerating) : false,
