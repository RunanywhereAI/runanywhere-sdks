...
exports.RAGDocument = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.RAGDocument_MetadataEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
...
exports.RAGIngestRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.documents) {
            exports.RAGDocument.encode(v, writer.uint32(18).fork()).ldelim();
        }
        if (message.replaceExisting !== false) {
            writer.uint32(24).bool(message.replaceExisting);
        }
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.RAGIngestRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.RAGQueryRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.options !== undefined) {
            exports.RAGQueryOptions.encode(message.options, writer.uint32(18).fork()).ldelim();
        }
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.RAGQueryRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(26).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.RAGSearchResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.RAGSearchResult_MetadataEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
        if (message.rank !== 0) {
...
exports.RAGResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.retrievedChunks) {
            exports.RAGSearchResult.encode(v, writer.uint32(18).fork()).ldelim();
        }
...
exports.RAGIngestResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.statistics !== undefined) {
            exports.RAGStatistics.encode(message.statistics, writer.uint32(34).fork()).ldelim();
        }
        if (message.errorMessage !== undefined) {
...
exports.RAGStreamEvent = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.chunk !== undefined) {
            exports.RAGSearchResult.encode(message.chunk, writer.uint32(42).fork()).ldelim();
        }
        if (message.token !== "") {
            writer.uint32(50).string(message.token);
        }
        if (message.result !== undefined) {
            exports.RAGResult.encode(message.result, writer.uint32(58).fork()).ldelim();
        }
        if (message.errorMessage !== undefined) {
...
exports.RAGServiceState = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.statistics !== undefined) {
            exports.RAGStatistics.encode(message.statistics, writer.uint32(18).fork()).ldelim();
        }
