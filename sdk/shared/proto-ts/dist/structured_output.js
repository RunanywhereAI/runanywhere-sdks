...
exports.JSONSchemaProperty = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.itemsSchema !== undefined) {
            exports.JSONSchema.encode(message.itemsSchema, writer.uint32(42).fork()).ldelim();
        }
        if (message.objectSchema !== undefined) {
            exports.JSONSchema.encode(message.objectSchema, writer.uint32(50).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        return {
            ...
            itemsSchema: isSet(object.itemsSchema) ? exports.JSONSchema.fromJSON(object.itemsSchema) : undefined,
            objectSchema: isSet(object.objectSchema) ? exports.JSONSchema.fromJSON(object.objectSchema) : undefined,
            ...
            defaultJson: isSet(object.defaultJson) ? globalThis.String(object.defaultJson) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.JSONSchema = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.properties).forEach(([key, value]) => {
            exports.JSONSchema_PropertiesEntry.encode({ key: key, value }, writer.uint32(18).fork()).ldelim();
        });
        for (const v of message.required) {
            writer.uint32(26).string(v);
        }
        if (message.items !== undefined) {
            exports.JSONSchemaProperty.encode(message.items, writer.uint32(34).fork()).ldelim();
        }
        ...
        Object.entries(message.definitions).forEach(([key, value]) => {
            exports.JSONSchema_DefinitionsEntry.encode({ key: key, value }, writer.uint32(82).fork()).ldelim();
        });
        if (message.ref !== undefined) {
            writer.uint32(90).string(message.ref);
        }
        for (const v of message.allOf) {
            exports.JSONSchema.encode(v, writer.uint32(98).fork()).ldelim();
        }
        for (const v of message.anyOf) {
            exports.JSONSchema.encode(v, writer.uint32(106).fork()).ldelim();
        }
        for (const v of message.oneOf) {
            exports.JSONSchema.encode(v, writer.uint32(114).fork()).ldelim();
        }
        if (message.notSchema !== undefined) {
            exports.JSONSchema.encode(message.notSchema, writer.uint32(122).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        return {
            ...
            allOf: globalThis.Array.isArray(object?.allOf) ? object.allOf.map((e) => exports.JSONSchema.fromJSON(e)) : [],
            anyOf: globalThis.Array.isArray(object?.anyOf) ? object.anyOf.map((e) => exports.JSONSchema.fromJSON(e)) : [],
            oneOf: globalThis.Array.isArray(object?.oneOf) ? object.oneOf.map((e) => exports.JSONSchema.fromJSON(e)) : [],
            notSchema: isSet(object.notSchema) ? exports.JSONSchema.fromJSON(object.notSchema) : undefined,
            rawJson: isSet(object.rawJson) ? globalThis.String(object.rawJson) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.JSONSchema_PropertiesEntry = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.value !== undefined) {
            exports.JSONSchemaProperty.encode(message.value, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.JSONSchema_DefinitionsEntry = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.value !== undefined) {
            exports.JSONSchema.encode(message.value, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.StructuredOutputOptions = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.schema !== undefined) {
            exports.JSONSchema.encode(message.schema, writer.uint32(10).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        return {
            ...
            regexPattern: isSet(object.regexPattern) ? globalThis.String(object.regexPattern) : undefined,
            grammar: isSet(object.grammar) ? globalThis.String(object.grammar) : undefined,
            repairJson: isSet(object.repairJson) ? globalThis.Boolean(object.repairJson) : false,
    ...
    fromJSON(object) {
        return {
            ...
            validationErrors: globalThis.Array.isArray(object?.validationErrors)
                ...
                : [],
            validationTimeMs: isSet(object.validationTimeMs) ? globalThis.Number(object.validationTimeMs) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.StructuredOutputResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.validation !== undefined) {
            exports.StructuredOutputValidation.encode(message.validation, writer.uint32(18).fork()).ldelim();
        }
...
exports.StructuredOutputParseRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.options !== undefined) {
            exports.StructuredOutputOptions.encode(message.options, writer.uint32(26).fork()).ldelim();
        }
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.StructuredOutputParseRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.StructuredOutputValidationRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.options !== undefined) {
            exports.StructuredOutputOptions.encode(message.options, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.StructuredOutputPromptResult = {
    ...
    fromJSON(object) {
        return {
            preparedPrompt: isSet(object.preparedPrompt) ? globalThis.String(object.preparedPrompt) : "",
...
exports.StructuredOutputRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.StructuredOutputRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.StructuredOutputStreamEvent = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.validation !== undefined) {
            exports.StructuredOutputValidation.encode(message.validation, writer.uint32(58).fork()).ldelim();
        }
        if (message.result !== undefined) {
            exports.StructuredOutputResult.encode(message.result, writer.uint32(66).fork()).ldelim();
        }
        if (message.errorMessage !== undefined) {
    ...
    fromJSON(object) {
        return {
            ...
            partialJson: isSet(object.partialJson) ? globalThis.String(object.partialJson) : undefined,
            validation: isSet(object.validation) ? exports.StructuredOutputValidation.fromJSON(object.validation) : undefined,
...
exports.EntityExtractionResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.entities) {
            exports.NamedEntity.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.ClassificationResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.alternatives) {
            exports.ClassificationCandidate.encode(v, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
