...
exports.STTTranscriptionRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.audio !== undefined) {
            exports.STTAudioSource.encode(message.audio, writer.uint32(18).fork()).ldelim();
        }
        if (message.options !== undefined) {
            exports.STTOptions.encode(message.options, writer.uint32(26).fork()).ldelim();
        }
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.STTTranscriptionRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.TranscriptionAlternative = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.words) {
            exports.WordTimestamp.encode(v, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.STTOutput = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.words) {
            exports.WordTimestamp.encode(v, writer.uint32(34).fork()).ldelim();
        }
        for (const v of message.alternatives) {
            exports.TranscriptionAlternative.encode(v, writer.uint32(42).fork()).ldelim();
        }
        if (message.metadata !== undefined) {
            exports.TranscriptionMetadata.encode(message.metadata, writer.uint32(50).fork()).ldelim();
        }
        if (message.languageCode !== undefined) {
...
exports.STTPartialResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.alternatives) {
            exports.TranscriptionAlternative.encode(v, writer.uint32(58).fork()).ldelim();
        }
        if (message.languageCode !== undefined) {
            writer.uint32(66).string(message.languageCode);
        }
        ...
        if (message.finalOutput !== undefined) {
            exports.STTOutput.encode(message.finalOutput, writer.uint32(106).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            finalOutput: isSet(object.finalOutput) ? exports.STTOutput.fromJSON(object.finalOutput) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.STTStreamEvent = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.partial !== undefined) {
            exports.STTPartialResult.encode(message.partial, writer.uint32(42).fork()).ldelim();
        }
        if (message.finalOutput !== undefined) {
            exports.STTOutput.encode(message.finalOutput, writer.uint32(50).fork()).ldelim();
        }
        if (message.errorMessage !== undefined) {
