...
exports.LLMGenerateRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.LLMGenerateRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(202).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.LLMStreamEvent = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.result !== undefined) {
            exports.LLMStreamFinalResult.encode(message.result, writer.uint32(82).fork()).ldelim();
        }
        if (message.errorCode !== 0) {
