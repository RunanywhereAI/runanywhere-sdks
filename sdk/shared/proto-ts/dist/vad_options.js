...
exports.VADProcessRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.audio !== undefined) {
            exports.VADAudioSource.encode(message.audio, writer.uint32(18).fork()).ldelim();
        }
        if (message.options !== undefined) {
            exports.VADOptions.encode(message.options, writer.uint32(26).fork()).ldelim();
        }
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.VADProcessRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.VADResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.statistics !== undefined) {
            exports.VADStatistics.encode(message.statistics, writer.uint32(66).fork()).ldelim();
        }
...
exports.SpeechActivityEvent = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.result !== undefined) {
            exports.VADResult.encode(message.result, writer.uint32(42).fork()).ldelim();
        }
...
exports.VADStreamEvent = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.activity !== undefined) {
            exports.SpeechActivityEvent.encode(message.activity, writer.uint32(50).fork()).ldelim();
        }
        if (message.statistics !== undefined) {
            exports.VADStatistics.encode(message.statistics, writer.uint32(58).fork()).ldelim();
        }
        if (message.errorMessage !== undefined) {
