...
exports.EmbeddingVector = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.EmbeddingVector_MetadataEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.EmbeddingsRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.options !== undefined) {
            exports.EmbeddingsOptions.encode(message.options, writer.uint32(18).fork()).ldelim();
        }
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.EmbeddingsRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.EmbeddingsResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.vectors) {
            exports.EmbeddingVector.encode(v, writer.uint32(10).fork()).ldelim();
        }
        if (message.dimension !== 0) {
...
exports.EmbeddingsCreateRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.configuration !== undefined) {
            exports.EmbeddingsConfiguration.encode(message.configuration, writer.uint32(18).fork()).ldelim();
        }
        if (message.configJson !== undefined) {
