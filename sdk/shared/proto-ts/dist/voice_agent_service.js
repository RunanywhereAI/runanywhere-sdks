    ...
    fromJSON(object) {
        return {
            ...
            categories: globalThis.Array.isArray(object?.categories)
                ...
                : [],
            minSeverity: isSet(object.minSeverity) ? (0, errors_1.errorSeverityFromJSON)(object.minSeverity) : 0,
...
exports.VoiceAgentResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.finalState !== undefined) {
            voice_events_1.VoiceAgentComponentStates.encode(message.finalState, writer.uint32(50).fork()).ldelim();
        }
    ...
    fromJSON(object) {
        return {
            ...
            finalState: isSet(object.finalState) ? voice_events_1.VoiceAgentComponentStates.fromJSON(object.finalState) : undefined,
...
exports.VoiceAgentTurnRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.sessionConfig !== undefined) {
            exports.VoiceSessionConfig.encode(message.sessionConfig, writer.uint32(58).fork()).ldelim();
        }
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.VoiceAgentTurnRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(66).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            sessionConfig: isSet(object.sessionConfig) ? exports.VoiceSessionConfig.fromJSON(object.sessionConfig) : undefined,
...
exports.VoiceAgentComposeConfig = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.sessionConfig !== undefined) {
            exports.VoiceSessionConfig.encode(message.sessionConfig, writer.uint32(162).fork()).ldelim();
        }
        if (message.audioPipelineConfig !== undefined) {
            exports.AudioPipelineConfig.encode(message.audioPipelineConfig, writer.uint32(170).fork()).ldelim();
        }
...
exports.VoiceAgentSynthesizeSpeechProtoRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.options !== undefined) {
            tts_options_1.TTSOptions.encode(message.options, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
