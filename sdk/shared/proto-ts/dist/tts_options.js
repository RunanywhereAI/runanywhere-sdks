...
exports.TTSConfiguration = {
    ...
    fromJSON(object) {
        return {
            ...
            audioFormat: isSet(object.audioFormat) ? (0, model_types_1.audioFormatFromJSON)(object.audioFormat) : 0,
...
exports.TTSSynthesisRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.options !== undefined) {
            exports.TTSOptions.encode(message.options, writer.uint32(34).fork()).ldelim();
        }
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.TTSSynthesisRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.TTSOutput = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.phonemeTimestamps) {
            exports.TTSPhonemeTimestamp.encode(v, writer.uint32(42).fork()).ldelim();
        }
        if (message.metadata !== undefined) {
            exports.TTSSynthesisMetadata.encode(message.metadata, writer.uint32(50).fork()).ldelim();
        }
...
exports.TTSSpeakResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.metadata !== undefined) {
            exports.TTSSynthesisMetadata.encode(message.metadata, writer.uint32(42).fork()).ldelim();
        }
        if (message.timestampMs !== 0) {
...
exports.TTSVoiceList = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.voices) {
            exports.TTSVoiceInfo.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.TTSStreamEvent = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.output !== undefined) {
            exports.TTSOutput.encode(message.output, writer.uint32(42).fork()).ldelim();
        }
        if (message.phoneme !== undefined) {
            exports.TTSPhonemeTimestamp.encode(message.phoneme, writer.uint32(50).fork()).ldelim();
        }
        if (message.speakResult !== undefined) {
            exports.TTSSpeakResult.encode(message.speakResult, writer.uint32(58).fork()).ldelim();
        }
        if (message.errorMessage !== undefined) {
    ...
    fromJSON(object) {
        return {
            ...
            speakResult: isSet(object.speakResult) ? exports.TTSSpeakResult.fromJSON(object.speakResult) : undefined,
            errorMessage: isSet(object.errorMessage) ? globalThis.String(object.errorMessage) : undefined,
            errorCode: isSet(object.errorCode) ? globalThis.Number(object.errorCode) : 0,
...
exports.TTSServiceState = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.voices) {
            exports.TTSVoiceInfo.encode(v, writer.uint32(26).fork()).ldelim();
        }
