...
exports.DownloadPlanRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.model !== undefined) {
            model_types_1.ModelInfo.encode(message.model, writer.uint32(18).fork()).ldelim();
        }
...
exports.DownloadFilePlan = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.file !== undefined) {
            model_types_1.ModelFileDescriptor.encode(message.file, writer.uint32(10).fork()).ldelim();
        }
        if (message.storageKey !== "") {
...
exports.DownloadPlanResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.files) {
            exports.DownloadFilePlan.encode(v, writer.uint32(26).fork()).ldelim();
        }
        if (message.totalBytes !== 0) {
            writer.uint32(32).int64(message.totalBytes);
        }
...
exports.DownloadStartRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.plan !== undefined) {
            exports.DownloadPlanResult.encode(message.plan, writer.uint32(18).fork()).ldelim();
        }
...
exports.DownloadStartResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.initialProgress !== undefined) {
            exports.DownloadProgress.encode(message.initialProgress, writer.uint32(34).fork()).ldelim();
        }
        if (message.errorMessage !== "") {
    ...
    fromJSON(object) {
        return {
            ...
            taskId: isSet(object.taskId) ? globalThis.String(object.taskId) : "",
            modelId: isSet(object.modelId) ? globalThis.String(object.modelId) : "",
            initialProgress: isSet(object.initialProgress) ? exports.DownloadProgress.fromJSON(object.initialProgress) : undefined,
            errorMessage: isSet(object.errorMessage) ? globalThis.String(object.errorMessage) : "",
            resumeToken: isSet(object.resumeToken) ? globalThis.String(object.resumeToken) : "",
        };
    },
