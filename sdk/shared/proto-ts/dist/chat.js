...
exports.ChatAttachment = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.ChatAttachment_MetadataEntry.encode({ key: key, value }, writer.uint32(66).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.ChatMessage = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.toolCalls) {
            tool_calling_1.ToolCall.encode(v, writer.uint32(66).fork()).ldelim();
        }
        if (message.toolResult !== undefined) {
            tool_calling_1.ToolResult.encode(message.toolResult, writer.uint32(74).fork()).ldelim();
        }
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.ChatMessage_MetadataEntry.encode({ key: key, value }, writer.uint32(106).fork()).ldelim();
        });
        for (const v of message.attachments) {
            exports.ChatAttachment.encode(v, writer.uint32(114).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            toolCalls: globalThis.Array.isArray(object?.toolCalls)
                ...
                : [],
            toolResult: isSet(object.toolResult) ? tool_calling_1.ToolResult.fromJSON(object.toolResult) : undefined,
...
exports.ChatGenerationRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.messages) {
            exports.ChatMessage.encode(v, writer.uint32(26).fork()).ldelim();
        }
        if (message.options !== undefined) {
            llm_options_1.LLMGenerationOptions.encode(message.options, writer.uint32(34).fork()).ldelim();
        }
        if (message.toolCalling !== undefined) {
            tool_calling_1.ToolCallingOptions.encode(message.toolCalling, writer.uint32(42).fork()).ldelim();
        }
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.ChatGenerationRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
...
exports.ChatGenerationResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.message !== undefined) {
            exports.ChatMessage.encode(message.message, writer.uint32(18).fork()).ldelim();
        }
        if (message.generation !== undefined) {
            llm_options_1.LLMGenerationResult.encode(message.generation, writer.uint32(26).fork()).ldelim();
        }
        for (const v of message.toolCalls) {
            tool_calling_1.ToolCall.encode(v, writer.uint32(34).fork()).ldelim();
        }
        for (const v of message.toolResults) {
            tool_calling_1.ToolResult.encode(v, writer.uint32(42).fork()).ldelim();
        }
        if (message.errorMessage !== undefined) {
...
exports.ChatStreamEvent = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.message !== undefined) {
            exports.ChatMessage.encode(message.message, writer.uint32(58).fork()).ldelim();
        }
        if (message.toolCall !== undefined) {
            tool_calling_1.ToolCall.encode(message.toolCall, writer.uint32(66).fork()).ldelim();
        }
        if (message.toolResult !== undefined) {
            tool_calling_1.ToolResult.encode(message.toolResult, writer.uint32(74).fork()).ldelim();
        }
        if (message.finalResult !== undefined) {
            llm_options_1.LLMGenerationResult.encode(message.finalResult, writer.uint32(82).fork()).ldelim();
        }
        if (message.errorMessage !== undefined) {
    ...
    fromJSON(object) {
        return {
            ...
            toolResult: isSet(object.toolResult) ? tool_calling_1.ToolResult.fromJSON(object.toolResult) : undefined,
            finalResult: isSet(object.finalResult) ? llm_options_1.LLMGenerationResult.fromJSON(object.finalResult) : undefined,
            errorMessage: isSet(object.errorMessage) ? globalThis.String(object.errorMessage) : undefined,
            errorCode: isSet(object.errorCode) ? globalThis.Number(object.errorCode) : 0,
        };
    },
...
exports.ChatConversationState = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.messages) {
            exports.ChatMessage.encode(v, writer.uint32(18).fork()).ldelim();
        }
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.ChatConversationState_MetadataEntry.encode({ key: key, value }, writer.uint32(42).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
