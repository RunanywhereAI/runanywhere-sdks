...
exports.PipelineSpec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.operators) {
            exports.OperatorSpec.encode(v, writer.uint32(18).fork()).ldelim();
        }
        for (const v of message.edges) {
            exports.EdgeSpec.encode(v, writer.uint32(26).fork()).ldelim();
        }
        if (message.options !== undefined) {
            exports.PipelineOptions.encode(message.options, writer.uint32(34).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.OperatorSpec = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.params).forEach(([key, value]) => {
            exports.OperatorSpec_ParamsEntry.encode({ key: key, value }, writer.uint32(26).fork()).ldelim();
        });
