...
exports.LLMGenerationOptions = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.thinkingPattern !== undefined) {
            thinking_tag_pattern_1.ThinkingTagPattern.encode(message.thinkingPattern, writer.uint32(90).fork()).ldelim();
        }
        if (message.executionTarget !== undefined) {
            writer.uint32(96).int32(message.executionTarget);
        }
        if (message.structuredOutput !== undefined) {
            structured_output_1.StructuredOutputOptions.encode(message.structuredOutput, writer.uint32(106).fork()).ldelim();
        }
        ...
        if (message.toolCalling !== undefined) {
            tool_calling_1.ToolCallingOptions.encode(message.toolCalling, writer.uint32(194).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            preferredFramework: isSet(object.preferredFramework) ? (0, model_types_1.inferenceFrameworkFromJSON)(object.preferredFramework) : 0,
            ...
            toolCalling: isSet(object.toolCalling) ? tool_calling_1.ToolCallingOptions.fromJSON(object.toolCalling) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.LLMGenerationResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.performance !== undefined) {
            exports.PerformanceMetrics.encode(message.performance, writer.uint32(114).fork()).ldelim();
        }
        if (message.executedOn !== undefined) {
            writer.uint32(120).int32(message.executedOn);
        }
        if (message.structuredOutputValidation !== undefined) {
            structured_output_1.StructuredOutputValidation.encode(message.structuredOutputValidation, writer.uint32(130).fork()).ldelim();
        }
        ...
        for (const v of message.toolCalls) {
            tool_calling_1.ToolCall.encode(v, writer.uint32(186).fork()).ldelim();
        }
        for (const v of message.toolResults) {
            tool_calling_1.ToolResult.encode(v, writer.uint32(194).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
...
exports.LLMGenerationRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.options !== undefined) {
            exports.LLMGenerationOptions.encode(message.options, writer.uint32(34).fork()).ldelim();
        }
        for (const v of message.contextChunks) {
            writer.uint32(42).string(v);
        }
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.LLMGenerationRequest_MetadataEntry.encode({ key: key, value }, writer.uint32(50).fork()).ldelim();
        });
