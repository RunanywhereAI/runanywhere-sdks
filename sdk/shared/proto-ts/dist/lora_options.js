...
exports.LoRAAdapterConfig = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.LoRAAdapterConfig_MetadataEntry.encode({ key: key, value }, writer.uint32(34).fork()).ldelim();
        });
...
exports.LoraAdapterCatalogEntry = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.LoraAdapterCatalogEntry_MetadataEntry.encode({ key: key, value }, writer.uint32(106).fork()).ldelim();
        });
...
exports.LoraAdapterCatalogListRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.query !== undefined) {
            exports.LoraAdapterCatalogQuery.encode(message.query, writer.uint32(10).fork()).ldelim();
        }
...
exports.LoraAdapterCatalogListResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.entries) {
            exports.LoraAdapterCatalogEntry.encode(v, writer.uint32(18).fork()).ldelim();
        }
...
exports.LoraAdapterCatalogGetResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.entry !== undefined) {
            exports.LoraAdapterCatalogEntry.encode(message.entry, writer.uint32(18).fork()).ldelim();
        }
        if (message.errorMessage !== "") {
            writer.uint32(26).string(message.errorMessage);
        }
...
exports.LoRAApplyRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.adapters) {
            exports.LoRAAdapterConfig.encode(v, writer.uint32(18).fork()).ldelim();
        }
...
exports.LoRAApplyResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.adapters) {
            exports.LoRAAdapterInfo.encode(v, writer.uint32(18).fork()).ldelim();
        }
        if (message.success !== false) {
...
exports.LoRAState = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.loadedAdapters) {
            exports.LoRAAdapterInfo.encode(v, writer.uint32(10).fork()).ldelim();
        }
