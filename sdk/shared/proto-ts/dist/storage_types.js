...
exports.StorageInfo = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.app !== undefined) {
            exports.AppStorageInfo.encode(message.app, writer.uint32(10).fork()).ldelim();
        }
        if (message.device !== undefined) {
            exports.DeviceStorageInfo.encode(message.device, writer.uint32(18).fork()).ldelim();
        }
        for (const v of message.models) {
            exports.ModelStorageMetrics.encode(v, writer.uint32(26).fork()).ldelim();
        }
...
exports.StorageAvailabilityResult = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.availability !== undefined) {
            exports.StorageAvailability.encode(message.availability, writer.uint32(18).fork()).ldelim();
        }
        for (const v of message.warnings) {
        ...
        if (message.deletePlan !== undefined) {
            exports.StorageDeletePlan.encode(message.deletePlan, writer.uint32(42).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            warnings: globalThis.Array.isArray(object?.warnings) ? object.warnings.map((e) => globalThis.String(e)) : [],
            errorMessage: isSet(object.errorMessage) ? globalThis.String(object.errorMessage) : "",
            deletePlan: isSet(object.deletePlan) ? exports.StorageDeletePlan.fromJSON(object.deletePlan) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
...
exports.StorageDeletePlan = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.candidates) {
            exports.StorageDeleteCandidate.encode(v, writer.uint32(34).fork()).ldelim();
        }
        for (const v of message.warnings) {
...
exports.StorageDeleteRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.plan !== undefined) {
            exports.StorageDeletePlan.encode(message.plan, writer.uint32(50).fork()).ldelim();
        }
