...
exports.VoiceEvent = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.userSaid !== undefined) {
            exports.UserSaidEvent.encode(message.userSaid, writer.uint32(82).fork()).ldelim();
        }
        if (message.assistantToken !== undefined) {
            exports.AssistantTokenEvent.encode(message.assistantToken, writer.uint32(90).fork()).ldelim();
        }
        if (message.audio !== undefined) {
            exports.AudioFrameEvent.encode(message.audio, writer.uint32(98).fork()).ldelim();
        }
        if (message.vad !== undefined) {
            exports.VADEvent.encode(message.vad, writer.uint32(106).fork()).ldelim();
        }
        if (message.interrupted !== undefined) {
            exports.InterruptedEvent.encode(message.interrupted, writer.uint32(114).fork()).ldelim();
        }
        if (message.state !== undefined) {
            exports.StateChangeEvent.encode(message.state, writer.uint32(122).fork()).ldelim();
        }
        if (message.error !== undefined) {
            exports.ErrorEvent.encode(message.error, writer.uint32(130).fork()).ldelim();
        }
        if (message.metrics !== undefined) {
            exports.MetricsEvent.encode(message.metrics, writer.uint32(138).fork()).ldelim();
        }
        if (message.componentStateChanged !== undefined) {
            exports.VoiceAgentComponentStates.encode(message.componentStateChanged, writer.uint32(146).fork()).ldelim();
        }
        if (message.sessionError !== undefined) {
            exports.VoiceSessionError.encode(message.sessionError, writer.uint32(154).fork()).ldelim();
        }
        if (message.sessionStarted !== undefined) {
            exports.SessionStartedEvent.encode(message.sessionStarted, writer.uint32(162).fork()).ldelim();
        }
        if (message.sessionStopped !== undefined) {
            exports.SessionStoppedEvent.encode(message.sessionStopped, writer.uint32(170).fork()).ldelim();
        }
        if (message.agentResponseStarted !== undefined) {
            exports.AgentResponseStartedEvent.encode(message.agentResponseStarted, writer.uint32(178).fork()).ldelim();
        }
        if (message.agentResponseCompleted !== undefined) {
            exports.AgentResponseCompletedEvent.encode(message.agentResponseCompleted, writer.uint32(186).fork()).ldelim();
        }
        if (message.speechTurnDetection !== undefined) {
            exports.SpeechTurnDetectionEvent.encode(message.speechTurnDetection, writer.uint32(194).fork()).ldelim();
        }
        if (message.turnLifecycle !== undefined) {
            exports.TurnLifecycleEvent.encode(message.turnLifecycle, writer.uint32(202).fork()).ldelim();
        }
        if (message.wakewordDetected !== undefined) {
            exports.WakeWordDetectedEvent.encode(message.wakewordDetected, writer.uint32(210).fork()).ldelim();
        }
        if (message.audioLevel !== undefined) {
            exports.AudioLevelEvent.encode(message.audioLevel, writer.uint32(218).fork()).ldelim();
        }
        if (message.componentProgress !== undefined) {
            exports.ComponentProgressEvent.encode(message.componentProgress, writer.uint32(226).fork()).ldelim();
        }
        ...
        Object.entries(message.metadata).forEach(([key, value]) => {
            exports.VoiceEvent_MetadataEntry.encode({ key: key, value }, writer.uint32(266).fork()).ldelim();
        });
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            userSaid: isSet(object.userSaid) ? exports.UserSaidEvent.fromJSON(object.userSaid) : undefined,
            assistantToken: isSet(object.assistantToken) ? exports.AssistantTokenEvent.fromJSON(object.assistantToken) : undefined,
            ...
            componentStateChanged: isSet(object.componentStateChanged)
                ...
                : undefined,
            sessionError: isSet(object.sessionError) ? exports.VoiceSessionError.fromJSON(object.sessionError) : undefined,
            sessionStarted: isSet(object.sessionStarted) ? exports.SessionStartedEvent.fromJSON(object.sessionStarted) : undefined,
            sessionStopped: isSet(object.sessionStopped) ? exports.SessionStoppedEvent.fromJSON(object.sessionStopped) : undefined,
            ...
            speechTurnDetection: isSet(object.speechTurnDetection)
                ...
                : undefined,
            turnLifecycle: isSet(object.turnLifecycle) ? exports.TurnLifecycleEvent.fromJSON(object.turnLifecycle) : undefined,
            wakewordDetected: isSet(object.wakewordDetected)
                ? exports.WakeWordDetectedEvent.fromJSON(object.wakewordDetected)
                : undefined,
            audioLevel: isSet(object.audioLevel) ? exports.AudioLevelEvent.fromJSON(object.audioLevel) : undefined,
...
exports.VoiceAgentComponentStates = {
    ...
    fromJSON(object) {
        return {
            sttState: isSet(object.sttState) ? (0, component_types_1.componentLifecycleStateFromJSON)(object.sttState) : 0,
            llmState: isSet(object.llmState) ? (0, component_types_1.componentLifecycleStateFromJSON)(object.llmState) : 0,
            ttsState: isSet(object.ttsState) ? (0, component_types_1.componentLifecycleStateFromJSON)(object.ttsState) : 0,
            vadState: isSet(object.vadState) ? (0, component_types_1.componentLifecycleStateFromJSON)(object.vadState) : 0,
            ...
            wakewordState: isSet(object.wakewordState) ? (0, component_types_1.componentLifecycleStateFromJSON)(object.wakewordState) : 0,
