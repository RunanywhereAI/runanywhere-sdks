...
export const VLMLoadResolvedArtifactsRequest: MessageFns<VLMLoadResolvedArtifactsRequest> = {
  encode(message: VLMLoadResolvedArtifactsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.modelId !== "") {
      writer.uint32(10).string(message.modelId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VLMLoadResolvedArtifactsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const VLMLoadResolvedArtifactsResponse: MessageFns<VLMLoadResolvedArtifactsResponse> = {
  encode(message: VLMLoadResolvedArtifactsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.handle !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VLMLoadResolvedArtifactsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
