...
export const DiffusionTokenizerSource = {
  encode(message: DiffusionTokenizerSource, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.kind !== 0) {
...
export const DiffusionConfiguration = {
  encode(message: DiffusionConfiguration, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
...
export const DiffusionConfig = {
  encode(message: DiffusionConfig, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
...
export const DiffusionGenerationOptions = {
  encode(message: DiffusionGenerationOptions, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.prompt !== "") {
...
export const DiffusionGenerationRequest = {
  encode(message: DiffusionGenerationRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.metadata).forEach(([key, value]) => {
      DiffusionGenerationRequest_MetadataEntry.encode({ key: key as any, value }, writer.uint32(34).fork()).ldelim();
    });
    return writer;
  },
...
export const DiffusionGenerationRequest_MetadataEntry = {
  encode(message: DiffusionGenerationRequest_MetadataEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
...
export const DiffusionProgress = {
  encode(message: DiffusionProgress, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9:
          ...
          message.etaMs = longToNumber(reader.int64() as Long);
          continue;
        case 10:
          if (tag !== 82) {
            break;
...
export const DiffusionResult = {
  encode(message: DiffusionResult, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.seedUsed = longToNumber(reader.int64() as Long);
          continue;
        case 5:
          if (tag !== 40) {
            break;
...
export const DiffusionCapabilities = {
  encode(message: DiffusionCapabilities, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
...
export const DiffusionStreamEvent = {
  encode(message: DiffusionStreamEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.seq !== 0) {
...
export const DiffusionServiceState = {
  encode(message: DiffusionServiceState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.isReady !== false) {
