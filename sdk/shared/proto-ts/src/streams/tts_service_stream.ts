 ...
 * Source: idl/tts_service.proto
 * Template: idl/codegen/templates/ts_async_iterable.njk
 *
 * GAP 09 Phase 14. Provides an AsyncIterable<TTSStreamEvent> client
...
export interface TTSStreamTransport {
    subscribe(
        ...
        onMessage: (msg: TTSStreamEvent) => void,
...
export function streamTTS(
    ...
    return {
        [Symbol.asyncIterator](): AsyncIterator<TTSStreamEvent> {
            const queue: TTSStreamEvent[] = [];
            let resolve: ((v: IteratorResult<TTSStreamEvent>) => void) | null = null;
