 ...
 * Source: idl/chat_service.proto
 * Template: idl/codegen/templates/ts_async_iterable.njk
 *
 * GAP 09 Phase 14. Provides an AsyncIterable<ChatStreamEvent> client
...
export interface ChatStreamTransport {
    subscribe(
        ...
        onMessage: (msg: ChatStreamEvent) => void,
...
export function streamChat(
    ...
    return {
        [Symbol.asyncIterator](): AsyncIterator<ChatStreamEvent> {
            ...
            let resolve: ((v: IteratorResult<ChatStreamEvent>) => void) | null = null;
