...
export const EmbeddingVector = {
  encode(message: EmbeddingVector, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.metadata).forEach(([key, value]) => {
      EmbeddingVector_MetadataEntry.encode({ key: key as any, value }, writer.uint32(50).fork()).ldelim();
    });
    return writer;
  },
...
export const EmbeddingVector_MetadataEntry = {
  encode(message: EmbeddingVector_MetadataEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
...
export const EmbeddingsRequest = {
  encode(message: EmbeddingsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    Object.entries(message.metadata).forEach(([key, value]) => {
      EmbeddingsRequest_MetadataEntry.encode({ key: key as any, value }, writer.uint32(42).fork()).ldelim();
    });
    return writer;
  },
...
export const EmbeddingsRequest_MetadataEntry = {
  encode(message: EmbeddingsRequest_MetadataEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
...
export const EmbeddingsServiceState = {
  encode(message: EmbeddingsServiceState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
