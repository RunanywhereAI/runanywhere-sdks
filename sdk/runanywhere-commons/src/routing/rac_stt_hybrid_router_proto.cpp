...
rac_result_t rac_stt_hybrid_router_transcribe_proto(
    ...
    *out_response_size = 0;
    ...
    // didn't pin a language — Sarvam rejects bare "en"; only BCP-47 region
    // forms like "en-IN" or the "unknown" sentinel are accepted. NULL here
    // lets each engine fall back to its own default (Sarvam: "unknown",
    // sherpa: whatever the model header declares).
