...
static JNIEnv* getJNIEnv() {
    ...
    if (status == JNI_EDETACHED) {
        // AttachCurrentThread's JNIEnv** param is typed as JNIEnv** on
        // Android NDK but as void** on macOS/Linux host JDKs. Cast through
        // void** - JNIEnv** and void** are layout-compatible on every
        // supported platform.
        if (g_jvm->AttachCurrentThread(
