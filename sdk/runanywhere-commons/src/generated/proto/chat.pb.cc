...
ChatMessage::_table_ = {
  {
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(ChatMessage, _impl_.role_), 6>(),
     {16, 6, 0,
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(ChatMessage, _impl_.timestamp_us_), 5>(),
     {32, 5, 0,
    ...
    // string id = 1;
    {PROTOBUF_FIELD_OFFSET(ChatMessage, _impl_.id_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // .runanywhere.v1.MessageRole role = 2;
    {PROTOBUF_FIELD_OFFSET(ChatMessage, _impl_.role_), _Internal::kHasBitsOffset + 6, 0, (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
    // string content = 3;
    ...
    // int64 timestamp_us = 4;
    {PROTOBUF_FIELD_OFFSET(ChatMessage, _impl_.timestamp_us_), _Internal::kHasBitsOffset + 5, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt64)},
    // optional string name = 5;
    {PROTOBUF_FIELD_OFFSET(ChatMessage, _impl_.name_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // repeated string tool_calls_json = 6;
    ...
    // optional string tool_call_id = 7;
    {PROTOBUF_FIELD_OFFSET(ChatMessage, _impl_.tool_call_id_), _Internal::kHasBitsOffset + 4, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
    "\32\2\0\7\0\4\17\14"
...
// @@protoc_insertion_point(message_clear_start:runanywhere.v1.ChatMessage)
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x00000060U)) {
    ::memset(&_impl_.timestamp_us_, 0, static_cast<::size_t>(
        ...
        reinterpret_cast<char*>(&_impl_.timestamp_us_)) + sizeof(_impl_.role_));
  }
