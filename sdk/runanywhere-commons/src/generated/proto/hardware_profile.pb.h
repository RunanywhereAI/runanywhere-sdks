...
/* @@protoc_insertion_point(class_definition:runanywhere.v1.HardwareProfile) */ {
 public:
  ...
  inline HardwareProfile(HardwareProfile&& from) noexcept
      : HardwareProfile(nullptr, ::std::move(from)) {}
  ...
  [[nodiscard]] static const HardwareProfile& default_instance() {
    return *reinterpret_cast<const HardwareProfile*>(
        &_HardwareProfile_default_instance_);
  }
...
/* @@protoc_insertion_point(class_definition:runanywhere.v1.AcceleratorInfo) */ {
 public:
  ...
  inline AcceleratorInfo(AcceleratorInfo&& from) noexcept
      : AcceleratorInfo(nullptr, ::std::move(from)) {}
  ...
  [[nodiscard]] static const AcceleratorInfo& default_instance() {
    return *reinterpret_cast<const AcceleratorInfo*>(
        &_AcceleratorInfo_default_instance_);
  }
...
/* @@protoc_insertion_point(class_definition:runanywhere.v1.HardwareProfileResult) */ {
 public:
  ...
  inline HardwareProfileResult(HardwareProfileResult&& from) noexcept
      : HardwareProfileResult(nullptr, ::std::move(from)) {}
  ...
  [[nodiscard]] static const HardwareProfileResult& default_instance() {
    return *reinterpret_cast<const HardwareProfileResult*>(
        &_HardwareProfileResult_default_instance_);
  }
 ...
 public:
  ...
  [[nodiscard]] const ::google::protobuf::RepeatedPtrField<::runanywhere::v1::AcceleratorInfo>& accelerators()
      const;
...
inline ::google::protobuf::RepeatedPtrField<::runanywhere::v1::AcceleratorInfo>* PROTOBUF_NONNULL HardwareProfileResult::mutable_accelerators()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
