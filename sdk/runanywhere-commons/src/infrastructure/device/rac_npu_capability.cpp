 ...
 * @brief Compatibility Hexagon NPU capability probe.
 */
...
static_assert(static_cast<int32_t>(RAC_HEXAGON_ARCH_UNKNOWN) ==
              static_cast<int32_t>(runanywhere::v1::HEXAGON_ARCH_UNKNOWN));
static_assert(static_cast<int32_t>(RAC_HEXAGON_ARCH_V68) ==
              static_cast<int32_t>(runanywhere::v1::HEXAGON_ARCH_V68));
static_assert(static_cast<int32_t>(RAC_HEXAGON_ARCH_V69) ==
              static_cast<int32_t>(runanywhere::v1::HEXAGON_ARCH_V69));
static_assert(static_cast<int32_t>(RAC_HEXAGON_ARCH_V73) ==
...
constexpr SocArchEntry kSocArchTable[] = {
    {"SM8850", RAC_HEXAGON_ARCH_V81}, {"SM8750", RAC_HEXAGON_ARCH_V79},
    {"SM8650", RAC_HEXAGON_ARCH_V75}, {"SM8550", RAC_HEXAGON_ARCH_V73},
    {"SM7675", RAC_HEXAGON_ARCH_V73}, {"SM7635", RAC_HEXAGON_ARCH_V73},
    {"SM8475", RAC_HEXAGON_ARCH_V69}, {"SM8450", RAC_HEXAGON_ARCH_V69},
};

constexpr SocArchEntry kBoardArchTable[] = {
    {"SUN", RAC_HEXAGON_ARCH_V79},
    {"PINEAPPLE", RAC_HEXAGON_ARCH_V75},
    {"KALAMA", RAC_HEXAGON_ARCH_V73},
};
...
rac_bool_t is_qhexrt_supported(rac_hexagon_arch_t arch) {
    return (arch == RAC_HEXAGON_ARCH_V75 || arch == RAC_HEXAGON_ARCH_V79 ||
            arch == RAC_HEXAGON_ARCH_V81)
               ? RAC_TRUE
               : RAC_FALSE;
}
...
rac_result_t rac_npu_probe(rac_npu_info_t* out) {
    ...
    out->qhexrt_supported = is_qhexrt_supported(out->hexagon_arch);
    return RAC_SUCCESS;
}
...
#if defined(RAC_HAVE_PROTOBUF)
    rac_npu_info_t info{};
    const rac_result_t probe_rc = rac_npu_probe(&info);
