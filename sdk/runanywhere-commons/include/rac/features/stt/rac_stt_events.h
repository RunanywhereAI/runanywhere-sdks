...
RAC_API RAC_NODISCARD rac_result_t rac_stt_event_transcription_started(
...
RAC_API RAC_NODISCARD rac_result_t rac_stt_event_partial_transcript(const char* text, int32_t word_count);

RAC_API RAC_NODISCARD rac_result_t rac_stt_event_final_transcript(const char* text, float confidence);

RAC_API RAC_NODISCARD rac_result_t rac_stt_event_transcription_completed(
...
RAC_API RAC_NODISCARD rac_result_t rac_stt_event_transcription_failed(const char* transcription_id,
                                                        const char* model_id,
                                                        rac_result_t error_code,
                                                        const char* error_message);

RAC_API RAC_NODISCARD rac_result_t rac_stt_event_language_detected(const char* language, float confidence);
