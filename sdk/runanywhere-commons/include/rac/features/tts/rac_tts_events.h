...
RAC_API RAC_NODISCARD rac_result_t rac_tts_event_synthesis_started(const char* synthesis_id, const char* model_id,
                                                     int32_t character_count, int32_t sample_rate,
                                                     rac_inference_framework_t framework);

RAC_API RAC_NODISCARD rac_result_t rac_tts_event_synthesis_chunk(const char* synthesis_id, int32_t chunk_size);

RAC_API RAC_NODISCARD rac_result_t rac_tts_event_synthesis_completed(
...
RAC_API RAC_NODISCARD rac_result_t rac_tts_event_synthesis_failed(const char* synthesis_id, const char* model_id,
