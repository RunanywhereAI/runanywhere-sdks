...
RAC_API rac_result_t rac_vocoder_component_load_model(rac_handle_t handle, const char* model_path,
                                                      const char* model_id, const char* model_name);
RAC_API rac_result_t rac_vocoder_component_unload(rac_handle_t handle);
RAC_API rac_lifecycle_state_t rac_vocoder_component_get_state(rac_handle_t handle);
RAC_API rac_result_t rac_vocoder_component_get_metrics(rac_handle_t handle,
                                                       rac_lifecycle_metrics_t* out_metrics);
RAC_API void rac_vocoder_component_destroy(rac_handle_t handle);
RAC_API rac_result_t rac_vocoder_component_vocode_proto(rac_handle_t handle,
