...
RAC_API rac_result_t rac_engine_manifest_validate_vtable(
    const rac_engine_manifest_t* manifest,
    const rac_engine_vtable_t* vtable);

RAC_API rac_result_t rac_engine_manifest_attach_vtable(
    const rac_engine_manifest_t* manifest,
    const rac_engine_vtable_t* vtable);

RAC_API rac_result_t rac_engine_manifest_detach_vtable(
    const rac_engine_vtable_t* vtable);
...
static inline const rac_engine_vtable_t* rac_engine_entry_with_manifest(
    const rac_engine_manifest_t* manifest,
    const rac_engine_vtable_t* vtable) {
    return rac_engine_manifest_attach_vtable(manifest, vtable) == RAC_SUCCESS
               ? vtable
               : RAC_NULL;
}
