...
// Returns: true to continue, false to cancel
typedef bool (*ra_tts_stream_callback)(const float* samples, size_t num_samples, bool is_final,
                                       void* user_data);

// VAD streaming callback
typedef void (*ra_vad_stream_callback)(bool is_speech, float probability, double timestamp_ms,
                                       void* user_data);
