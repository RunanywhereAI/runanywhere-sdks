...
#   - npm
#   - Built WASM binaries (run bindings/web/scripts/build-web.sh first)
#
# Drives the in-repo minimal harness (bindings/web/example). The full
...
WEB_SDK_DIR="${REPO_ROOT}/bindings/web"
