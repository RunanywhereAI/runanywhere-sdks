 ...
 *       configure-time assertion block in core/CMakeLists.txt.
 ...
 * @see core/CMakeLists.txt (HAVE_ZLIB_H / HAVE_BZLIB_H
 *      configure-time assertion)
 * @see bindings/web/wasm/scripts/build.sh (post-build wasm string
 *      scan + config.h grep)
 */
