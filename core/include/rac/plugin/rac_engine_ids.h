/**
 * @file rac_engine_ids.h
 * @brief Canonical engine manifest identifiers.
 */

#ifndef RAC_PLUGIN_RAC_ENGINE_IDS_H
#define RAC_PLUGIN_RAC_ENGINE_IDS_H

#define RAC_ENGINE_ID_LLAMACPP "llamacpp"
#define RAC_ENGINE_ID_MLX "mlx"
