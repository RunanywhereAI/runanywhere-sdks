 ...
 *
 * Called for each UTF-8-safe text run generated by the model during streaming, and once more with
 ...
 * call.
 *
 * @param token The generated text run string (may be empty on the final call)
