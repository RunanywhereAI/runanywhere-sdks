...
#
# wasm.sh — wraps the commons wasm CMake configuration (Emscripten
...
BUILD_DIR="${COMMONS_DIR}/build/wasm"
...
# scripts/build/wasm/bundle.sh so this thin wrapper produces an
