...
#
# Usage:
#   ./scripts/build/wasm/setup-emsdk.sh              # Install to sdk/runanywhere-web-next/emsdk/
#   ./scripts/build/wasm/setup-emsdk.sh /opt/emsdk   # Install to custom path
#
...
EMSDK_VERSION="5.0.0"
INSTALL_DIR="${1:-${RAC_ROOT}/sdk/runanywhere-web-next/emsdk}"
...
echo "  ./scripts/build/wasm/bundle.sh"
