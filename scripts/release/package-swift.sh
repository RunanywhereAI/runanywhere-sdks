#!/usr/bin/env bash
# scripts/release/package-swift.sh
...
#
# USAGE:
#   package-swift.sh [--mode local|ci] [--natives-from PATH]
#
# OPTIONS:
...
echo "   freshly-released zips (run scripts/release/sync-checksums.sh on release)."
