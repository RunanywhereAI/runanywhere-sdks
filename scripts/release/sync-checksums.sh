...
#
# Usage:
#   scripts/release/sync-checksums.sh ZIP_DIR
#
# Example:
#   scripts/release/sync-checksums.sh sdk/runanywhere-commons/dist
#   scripts/release/sync-checksums.sh release-artifacts/native-ios-macos
#
