#!/bin/bash
# Web SDK build verification and smoke tests. See --help for options.
# Requires Node.js 18+ and built WASM binaries
...
WEB_APP_DIR="${RAC_ROOT}/examples/web-next/RunAnywhereAI"
