...
# postinstall, scripts/examples/react-native/verify.sh, README/CLAUDE setup
# steps) MUST flow through this script so the gems are guaranteed to be
# installed before `bundle exec pod install` is invoked.
#
...
APP_ROOT="${RAC_ROOT}/examples/react-native/RunAnywhereAI"
