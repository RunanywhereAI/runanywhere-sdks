...
Java_com_runanywhere_sdk_core_whispercpp_WhisperCPPBridge_nativeRegister(
  ...
  // v3 Phase B9: list TRANSCRIBE plugins for debug visibility.
  {
    ...
    LOGi("After WhisperCPP registration - TRANSCRIBE plugins: count=%zu, "
         "result=%d",
...
JNIEXPORT jint JNICALL
Java_com_runanywhere_sdk_core_whispercpp_WhisperCPPBridge_nativeUnregister(
    JNIEnv *env, jclass clazz) {
  (void)env;
  (void)clazz;
...
Java_com_runanywhere_sdk_core_whispercpp_WhisperCPPBridge_nativeIsRegistered(
    JNIEnv *env, jclass clazz) {
  (void)env;
  (void)clazz;
...
Java_com_runanywhere_sdk_core_whispercpp_WhisperCPPBridge_nativeGetVersion(
    JNIEnv *env, jclass clazz) {
  (void)clazz;
