...
```powershell
irm https://raw.githubusercontent.com/RunanywhereAI/runanywhere-sdks/main/apps/rcli/scripts/install.ps1 | iex
```
...
```bash
# macOS (full MLX host):
CONFIGURATION=release ./apps/rcli/scripts/build-mlx-cli.sh
...
bash core/tests/scripts/run-cli-e2e-linux.sh
```
