...
//   .package(url: "https://github.com/RunanywhereAI/runanywhere-sdks", from: "0.20.16")
    ...
    if useLocalNatives {
        ...
        return [
            .binaryTarget(
                ...
                checksum: "ab8a55119b8ff73801ff2f4ecd060252a0880adef92d2856ffeeea447174ab55"
            ),
            .binaryTarget(
                name: "RABackendLlamaCPPBinary",
