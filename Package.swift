...
//   .package(url: "https://github.com/RunanywhereAI/runanywhere-sdks", from: "0.20.15")
    ...
    if useLocalNatives {
        ...
        return [
            .binaryTarget(
                ...
                checksum: "9322954da0f8c283e606e66683c4c645fcee6578f63ad1f34766f61af24e6e3f"
            ),
            .binaryTarget(
                name: "RABackendLlamaCPPBinary",
