package com.runanywhere.runanywhereai.ui.screens.npu.theme

import androidx.compose.ui.graphics.Color

// Palette mirrored from the RunAnywhereAI example app so the demos share one
// brand: orange primary, warm neutrals, warm-gold tertiary, emerald success.
...
// Success — emerald (semantic; not part of the Material scheme). Used for the
// "NPU ready" state; reads well on both light and dark surfaces.
val RaSuccess = Color(0xFF10B981)
