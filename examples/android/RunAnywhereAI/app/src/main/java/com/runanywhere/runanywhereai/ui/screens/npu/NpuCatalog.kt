...
val NPU_MODELS = listOf(
    ...
    NpuModel(
        ...
        detail = "TTS · 15M · Hexagon v81 (StyleTTS2, qhx_say, ONE baked canonical phrase — no live g2p yet)",
        modality = NpuModality.TTS,
        arch = "v81",
        files = hfFiles(
            "runanywhere/kitten_nano_0_8_HNPU", "v81",
            "kitten_nano08_v81.json",
            "host_weights/F0_0_conv1_bias.bin",
            "host_weights/F0_0_conv1_weight.bin",
            "host_weights/F0_0_conv2_bias.bin",
            "host_weights/F0_0_conv2_weight.bin",
            "host_weights/F0_0_norm1_fc_bias.bin",
            "host_weights/F0_0_norm1_fc_weight.bin",
            "host_weights/F0_0_norm1_norm_bias.bin",
            "host_weights/F0_0_norm1_norm_weight.bin",
            "host_weights/F0_0_norm2_fc_bias.bin",
            "host_weights/F0_0_norm2_fc_weight.bin",
            "host_weights/F0_1_conv1_bias.bin",
            "host_weights/F0_1_conv1_weight.bin",
            "host_weights/F0_1_conv1x1_weight.bin",
            "host_weights/F0_1_conv2_bias.bin",
            "host_weights/F0_1_conv2_weight.bin",
            "host_weights/F0_1_norm1_fc_bias.bin",
            "host_weights/F0_1_norm1_fc_weight.bin",
            "host_weights/F0_1_norm2_fc_bias.bin",
            "host_weights/F0_1_norm2_fc_weight.bin",
            "host_weights/F0_1_norm2_norm_bias.bin",
            "host_weights/F0_1_norm2_norm_weight.bin",
            "host_weights/F0_1_pool_bias.bin",
            "host_weights/F0_1_pool_weight.bin",
            "host_weights/F0_2_conv1_bias.bin",
            "host_weights/F0_2_conv1_weight.bin",
            "host_weights/F0_2_conv2_bias.bin",
            "host_weights/F0_2_conv2_weight.bin",
            "host_weights/F0_2_norm1_fc_bias.bin",
            "host_weights/F0_2_norm1_fc_weight.bin",
            "host_weights/F0_2_norm2_fc_bias.bin",
            "host_weights/F0_2_norm2_fc_weight.bin",
            "host_weights/F0_proj_bias.bin",
            "host_weights/F0_proj_weight.bin",
            "host_weights/LSTM_6019.bin",
            "host_weights/LSTM_6020.bin",
            "host_weights/LSTM_6021.bin",
            "host_weights/MatMul_6116.bin",
            "host_weights/N_0_conv1_bias.bin",
            "host_weights/N_0_conv1_weight.bin",
            "host_weights/N_0_conv2_bias.bin",
            "host_weights/N_0_conv2_weight.bin",
            "host_weights/N_0_norm1_fc_bias.bin",
            "host_weights/N_0_norm1_fc_weight.bin",
            "host_weights/N_0_norm2_fc_bias.bin",
            "host_weights/N_0_norm2_fc_weight.bin",
            "host_weights/N_1_conv1_bias.bin",
            "host_weights/N_1_conv1_weight.bin",
            "host_weights/N_1_conv1x1_weight.bin",
            "host_weights/N_1_conv2_bias.bin",
            "host_weights/N_1_conv2_weight.bin",
            "host_weights/N_1_norm1_fc_bias.bin",
            "host_weights/N_1_norm1_fc_weight.bin",
            "host_weights/N_1_norm2_fc_bias.bin",
            "host_weights/N_1_norm2_fc_weight.bin",
            "host_weights/N_1_pool_bias.bin",
            "host_weights/N_1_pool_weight.bin",
            "host_weights/N_2_conv1_bias.bin",
            "host_weights/N_2_conv1_weight.bin",
            "host_weights/N_2_conv2_bias.bin",
            "host_weights/N_2_conv2_weight.bin",
            "host_weights/N_2_norm1_fc_bias.bin",
            "host_weights/N_2_norm1_fc_weight.bin",
            "host_weights/N_2_norm2_fc_bias.bin",
            "host_weights/N_2_norm2_fc_weight.bin",
            "host_weights/N_proj_bias.bin",
            "host_weights/N_proj_weight.bin",
            "host_weights/harm.bin",
            "host_weights/l_linear_bias.bin",
            "kitten_graphA_v81.bin",
            "kitten_phrase/input_ids_i32.bin",
            "kitten_phrase/speed.bin",
            "kitten_phrase/style.bin",
            "kitten_voc64_v81.bin",
            addConfig = false,  // kitten repos have no repo-root config.json
        ),
    ),
    NpuModel(
        id = "kitten_mini_0_1_v81",
        name = "Kitten-mini-0.1 (HNPU)",
        detail = "TTS · 24M · Hexagon v81 (StyleTTS2, qhx_say, ONE baked canonical phrase — no live g2p yet)",
        modality = NpuModality.TTS,
        arch = "v81",
        files = hfFiles(
            "runanywhere/kitten_mini_0_1_HNPU", "v81",
            "kitten_mini01_v81.json",
            "host_weights/F0_0_conv1_bias.bin",
            "host_weights/F0_0_conv1_weight.bin",
            "host_weights/F0_0_conv2_bias.bin",
            "host_weights/F0_0_conv2_weight.bin",
            ...
            "host_weights/LSTM_6020.bin",
            "host_weights/LSTM_6021.bin",
            "host_weights/LSTM_8578.bin",
            "host_weights/LSTM_8579.bin",
            "host_weights/LSTM_8580.bin",
            "host_weights/LSTM_8798.bin",
            "host_weights/LSTM_8799.bin",
            "host_weights/LSTM_8800.bin",
            "host_weights/LSTM_8848.bin",
            "host_weights/LSTM_8849.bin",
            "host_weights/LSTM_8850.bin",
            "host_weights/LSTM_8898.bin",
            "host_weights/LSTM_8899.bin",
            "host_weights/LSTM_8900.bin",
            "host_weights/LSTM_8947.bin",
            "host_weights/LSTM_8948.bin",
            "host_weights/LSTM_8949.bin",
            "host_weights/LSTM_9004.bin",
            "host_weights/LSTM_9005.bin",
            "host_weights/LSTM_9006.bin",
            "host_weights/MatMul_6116.bin",
            "host_weights/N_0_conv1_bias.bin",
            "host_weights/N_0_conv1_weight.bin",
            "host_weights/N_0_conv2_bias.bin",
            ...
            "host_weights/harm.bin",
            "host_weights/l_linear_bias.bin",
            "kitten_mini01_gA_v81.bin",
            "kitten_mini01_voc_v81.bin",
            "kitten_phrase/input_ids_i32.bin",
            "kitten_phrase/speed.bin",
            "kitten_phrase/style.bin",
            addConfig = false,  // kitten repos have no repo-root config.json
