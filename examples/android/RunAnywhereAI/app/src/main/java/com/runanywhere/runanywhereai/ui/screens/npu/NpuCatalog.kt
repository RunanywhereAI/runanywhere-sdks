...
val NPU_MODELS = listOf(
    ...
    NpuModel(
        ...
        arch = "v81",
        files = hfFiles(
            "runanywhere/llama3_2_1b_HNPU", "v81",
            "llama-3.2-1b.json",
            "llama_dec_wqo_o3.bin",
            "llama_embed_f16.bin",
            "llama_lmhead.bin",
    ...
    NpuModel(
        ...
        detail = "LLM · E4B · Hexagon v81",
        modality = NpuModality.LLM,
        arch = "v81",
        files = hfFiles(
            "runanywhere/gemma4_e4b_HNPU", "v81",
            "gemma-4-E4B.json",
            "audio_fix/M.bin",
            "audio_fix/enc_feat.bin",
            "audio_fix/ridx.bin",
            "audio_host/audio_host_manifest.json",
            "audio_host/embed_audio_proj.bin",
            "audio_host/mel_filters.bin",
            "audio_host/sub_input_proj_linear_weight.bin",
            "audio_host/sub_layer0_conv_weight.bin",
            ...
            "g4v_proj_w_f32.bin",
            "g4v_rope_inv.bin",
            "gemma-4-E4B-audio.json",
            "gemma-4-E4B-vlm.json",
            "gemma4_audio_enc_f16.bin",
            "gemma4_vis_16blk_r2_f16.bin",
            "gemma4e4b_decode_p0_w8.bin",
            "gemma4e4b_decode_p1_w8.bin",
            "gemma4e4b_decode_p2_w8.bin",
            "gemma4e4b_embed_f16.bin",
            "gemma4e4b_lmh_f16.bin",
            "gemma4e4b_ple_norm_f16.bin",
            "gemma4e4b_ple_proj_f16.bin",
            "gemma4e4b_ple_table_f16.bin",
            "tokenizer.json",
        ),
    ),
    NpuModel(
        ...
        arch = "v81",
        files = hfFiles(
            "runanywhere/gemma3n_e4b_HNPU", "v81",
    ...
    NpuModel(
        id = "ternary_bonsai_1_7b_v79",
        name = "Ternary Bonsai 1.7B (HNPU)",
        detail = "LLM · 1.7B · Hexagon v79",
        modality = NpuModality.LLM,
        arch = "v79",
        files = hfFiles(
            "runanywhere/ternary_bonsai_1_7b_HNPU", "v79",
            "ternary-bonsai-1.7b-1024.json",
            "tbonsai17b_decn1k_w8.bin",
            "tbonsai17b_embed_f16.bin",
            "tbonsai17b_lmh_w8.bin",
            "tokenizer.json",
        ),
    ),
    NpuModel(
        id = "ternary_bonsai_1_7b_v81",
        name = "Ternary Bonsai 1.7B (HNPU)",
        detail = "LLM · 1.7B · Hexagon v81",
        modality = NpuModality.LLM,
        arch = "v81",
        files = hfFiles(
            "runanywhere/ternary_bonsai_1_7b_HNPU", "v81",
            "ternary-bonsai-1.7b-1024.json",
            "tbonsai17b_decn1k_w8.bin",
            "tbonsai17b_embed_f16.bin",
            "tbonsai17b_lmh_w8.bin",
