...
[![Version](https://img.shields.io/badge/version-0.20.26-blue.svg)](https://github.com/RunanywhereAI/runanywhere-sdks/releases)
...
Select version **`0.20.26`** (or `from: "0.20.26"`), then add the products you need. Resolve against the newest tag on the [Releases](https://github.com/RunanywhereAI/runanywhere-sdks/releases) page if `0.20.26` binary assets are not published yet.
