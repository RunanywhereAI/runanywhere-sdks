...
[![Version](https://img.shields.io/badge/version-0.20.22-blue.svg)](https://github.com/RunanywhereAI/runanywhere-sdks/releases)
...
Select version **`0.20.22`** (or `from: "0.20.22"`), then add the products you need. Resolve against the newest tag on the [Releases](https://github.com/RunanywhereAI/runanywhere-sdks/releases) page if `0.20.22` binary assets are not published yet.
...
```swift
dependencies: [
    .package(url: "https://github.com/RunanywhereAI/runanywhere-swift.git", from: "0.20.22")
],
targets: [
    .target(
        name: "YourApp",
