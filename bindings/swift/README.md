...
[![Version](https://img.shields.io/badge/version-0.20.38-blue.svg)](https://github.com/RunanywhereAI/runanywhere-sdks/releases)
...
Select version **`0.20.38`** (or `from: "0.20.38"`), then add the products you need. Resolve against the newest tag on the [Releases](https://github.com/RunanywhereAI/runanywhere-sdks/releases) page if `0.20.38` binary assets are not published yet.
...
```swift
dependencies: [
    .package(url: "https://github.com/RunanywhereAI/runanywhere-swift.git", from: "0.20.38")
],
targets: [
    .target(
        name: "YourApp",
