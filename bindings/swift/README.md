...
[![Version](https://img.shields.io/badge/version-0.20.27-blue.svg)](https://github.com/RunanywhereAI/runanywhere-sdks/releases)
...
Select version **`0.20.27`** (or `from: "0.20.27"`), then add the products you need. Resolve against the newest tag on the [Releases](https://github.com/RunanywhereAI/runanywhere-sdks/releases) page if `0.20.27` binary assets are not published yet.
