 ...
 *
 * Called for each UTF-8-safe text run generated by the model during streaming.
 *
 * @param token The generated text run string
 ...
 *
 * @param token The generated UTF-8-safe text run
 * @param user_data User-provided context
