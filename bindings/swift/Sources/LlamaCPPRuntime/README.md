...
Add the Swift package and include the `RunAnywhereLlamaCPP` product (pin `0.20.26`):

```swift
dependencies: [
    .package(url: "https://github.com/RunanywhereAI/runanywhere-swift.git", exact: "0.20.26"),
],
targets: [
    .target(
        name: "YourApp",
