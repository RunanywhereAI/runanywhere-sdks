...
Add the Swift package and include the `RunAnywhereLlamaCPP` product (pin `0.20.20`):

```swift
dependencies: [
    .package(url: "https://github.com/RunanywhereAI/runanywhere-swift.git", exact: "0.20.20"),
],
targets: [
    .target(
        name: "YourApp",
