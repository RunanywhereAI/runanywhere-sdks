#!/usr/bin/env bash
# =============================================================================
# bindings/swift/scripts/package-sdk.sh
# =============================================================================
...
#   --natives-from PATH  Directory containing *.xcframework (default: bindings/swift/Binaries/)
#
# OUTPUTS:
...
echo "   freshly-released zips (run bindings/swift/scripts/sync-checksums.sh on release)."
