 ...
 * `bindings/swift/Sources/RunAnywhere/Features/TTS/Services/AudioPlaybackManager.swift`
 * (AVAudioPlayer over in-memory WAV data, delegate-driven completion,
 * pause/resume, interruption handling) and the Kotlin port
 * `bindings/kotlin/src/main/kotlin/com/runanywhere/sdk/features/TTS/Services/AudioPlaybackManager.kt`
