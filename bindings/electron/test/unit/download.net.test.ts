...
import { downloadFile } from '../../dist/download';
import type { DownloadProgress } from '../../dist/download';
...
let server: http.Server | undefined; // shared in-process HTTP server (127.0.0.1, ephemeral port)
let baseUrl: string;                 // e.g. 'http://127.0.0.1:53421'
let tmpDir: string;                  // fresh temp dir for all downloaded files
