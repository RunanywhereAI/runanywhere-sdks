 ...
 * any event whose envelope `error` is set; there is no separate arm for it.
 * ===========================================================================
...
public class SDKEvent(
  ...
  init {
    require(countNonNull(initialization, configuration, generation, model, network, storage, framework, device, voice, voice_pipeline, component_lifecycle, session, auth, hardware_routing, capability, telemetry, cancellation) <= 1) {
      "At most one of initialization, configuration, generation, model, network, storage, framework, device, voice, voice_pipeline, component_lifecycle, session, auth, hardware_routing, capability, telemetry, cancellation may be non-null"
    }
  }
  ...
  ): SDKEvent = SDKEvent(timestamp_ms, severity, category, component, error, id, session_id, destination, properties, operation_id, source, seq, initialization, configuration, generation, model, network, storage, framework, device, voice, voice_pipeline, component_lifecycle, session, auth, hardware_routing, capability, telemetry, cancellation, unknownFields)
  ...
  public companion object {
    ...
    public val ADAPTER: ProtoAdapter<SDKEvent> = object : ProtoAdapter<SDKEvent>(
      ...
      override fun encodedSize(`value`: SDKEvent): Int {
        ...
        if (value.seq != 0L) {
          size += ProtoAdapter.UINT64.encodedSizeWithTag(37, value.seq)
        }
      ...
      override fun encode(writer: ProtoWriter, `value`: SDKEvent) {
        ...
        if (value.seq != 0L) {
          ProtoAdapter.UINT64.encodeWithTag(writer, 37, value.seq)
        }
      ...
      override fun decode(reader: ProtoReader): SDKEvent {
        ...
        val unknownFields = reader.forEachTag { tag ->
          when (tag) {
            ...
            37 -> seq = ProtoAdapter.UINT64.decode(reader)
