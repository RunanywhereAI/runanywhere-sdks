...
dependencies {
    // Core SDK (required)
    implementation("io.github.sanchitmonga22:runanywhere-sdk:0.20.28")

    // LLM support via llama.cpp (~34 MB)
    implementation("io.github.sanchitmonga22:runanywhere-llamacpp:0.20.28")

    // Optional: STT, TTS, VAD via ONNX/Sherpa (~25 MB)
    implementation("io.github.sanchitmonga22:runanywhere-onnx:0.20.28")
}
```
