 ...
 *   bindings/swift/Sources/RunAnywhere/Foundation/Bridge/Extensions/CppBridge+Platform.swift
 *   bindings/swift/Sources/RunAnywhere/Features/TTS/System/SystemTTSService.swift
 *
 * Apple-only — Android has no commons-level platform-TTS plugin (see
 * core/CMakeLists.txt:732 `if(APPLE AND RAC_BUILD_PLATFORM)`).
 */
...
// core/src/features/platform/rac_plugin_entry_platform.cpp.
