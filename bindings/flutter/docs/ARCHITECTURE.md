...
Backend packages depend on `runanywhere ^0.20.35`. Source checkouts prefer
...
| Component | Version |
|-----------|---------|
| `runanywhere` (Dart) | 0.20.35 |
| `runanywhere_llamacpp` | 0.20.35 |
| `runanywhere_mlx` | 0.20.35 |
| `runanywhere_onnx` | 0.20.35 |
| `runanywhere_qhexrt` | 0.20.35 |
