...
ORT_WASM_ARCHIVE="${REPO_ROOT}/core/third_party/onnxruntime-wasm/lib/libonnxruntime.a"
ORT_WEBGPU_WASM_ARCHIVE="${REPO_ROOT}/core/third_party/onnxruntime-wasm-webgpu/lib/libonnxruntime.a"
ORT_WASM_RUNTIME_DIR="${REPO_ROOT}/core/third_party/onnxruntime-wasm"
ORT_WEBGPU_WASM_RUNTIME_DIR="${REPO_ROOT}/core/third_party/onnxruntime-wasm-webgpu"
SHERPA_WASM_ARCHIVE="${REPO_ROOT}/core/third_party/sherpa-onnx-wasm/lib/libsherpa-onnx-c-api.a"
ORT_WASM_PROVENANCE="${REPO_ROOT}/core/third_party/onnxruntime-wasm/.rac-wasm-provenance"
ORT_WEBGPU_WASM_PROVENANCE="${REPO_ROOT}/core/third_party/onnxruntime-wasm-webgpu/.rac-wasm-provenance"
SHERPA_WASM_PROVENANCE="${REPO_ROOT}/core/third_party/sherpa-onnx-wasm/.rac-wasm-provenance"
...
if [ "$ONNX_REQUESTED" = "ON" ] && [ ! -f "${SHERPA_WASM_ARCHIVE}" ]; then
    echo "ERROR: --onnx requires core/third_party/sherpa-onnx-wasm/lib/libsherpa-onnx-c-api.a"
    echo "       Build or vendor Sherpa-ONNX WASM static archives first:"
    echo "       bindings/web/wasm/scripts/vendor-sherpa-onnx-wasm.sh"
    exit 1
fi
