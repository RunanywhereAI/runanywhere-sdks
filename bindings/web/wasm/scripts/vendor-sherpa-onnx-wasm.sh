...
DEST_DIR="${REPO_ROOT}/core/third_party/sherpa-onnx-wasm"
ORT_DIR="${REPO_ROOT}/core/third_party/onnxruntime-wasm"
...
if ! ort_provenance_matches; then
  ...
  echo "Run: bindings/web/wasm/scripts/vendor-onnxruntime-wasm.sh" >&2
  exit 1
fi
